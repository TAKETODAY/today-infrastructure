 ...
 * @see infra.transaction.support.TransactionSynchronizationManager#registerSynchronization
 * @see infra.transaction.reactive.TransactionSynchronizationManager#registerSynchronization
 * @since 4.0
 */
public interface TransactionExecutionListener {
  ...
  static TransactionExecutionListener empty() {
    return new Empty();
  }

  class Empty implements TransactionExecutionListener {
