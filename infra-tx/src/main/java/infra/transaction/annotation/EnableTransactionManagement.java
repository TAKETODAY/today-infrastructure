 ...
 * this case the {@code infra-aspects} module JAR must be present on the classpath, with
 ...
 * @see infra.transaction.aspectj.AspectJTransactionManagementConfiguration
 * @since 4.0
 */
@Documented
