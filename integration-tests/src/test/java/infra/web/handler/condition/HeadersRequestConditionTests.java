...
public class HeadersRequestConditionTests {
  ...
  public void headerEquals() {
    Assertions.assertThat(new HeadersRequestCondition("foo")).isEqualTo(new HeadersRequestCondition("foo"));
  ...
  public void getMatchingCondition() {
    ...
    HeadersRequestCondition result = condition.getMatchingCondition(new MockHttpContext(null, request, null));
