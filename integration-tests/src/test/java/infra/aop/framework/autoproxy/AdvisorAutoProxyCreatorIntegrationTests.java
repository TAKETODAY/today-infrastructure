 ...
 * @author Rod Johnson
 * @author Chris Beams
 * @see infra.aop.framework.autoproxy.AdvisorAutoProxyCreatorTests
 */
...
class NeverMatchAdvisor extends StaticMethodMatcherPointcutAdvisor {
  ...
  /**
   * @see infra.aop.MethodMatcher#matches(Method, Class)
   */
  @Override
...
class Rollback {
  ...
  /**
   * @infra.transaction.interceptor.RuleBasedTransaction (timeout = - 1)
   * @infra.transaction.interceptor.RollbackRule (" java.lang.Exception ")
   * @infra.transaction.interceptor.NoRollbackRule (" ServletException ")
   */
