...
import cn.taketoday.framework.autoconfigure.condition.scan.ScanBean;
import cn.taketoday.framework.autoconfigure.condition.scan.ScannedFactoryBeanConfiguration;
import cn.taketoday.framework.autoconfigure.condition.scan.ScannedFactoryBeanWithBeanMethodArgumentsConfiguration;
import cn.taketoday.framework.autoconfigure.context.PropertyPlaceholderAutoConfiguration;
...
class ConditionalOnMissingBeanTests {
	...
	@Configuration(proxyBeanMethods = false)
	@ComponentScan(basePackages = "cn.taketoday.framework.autoconfigure.condition.scan", useDefaultFilters = false,
	...
	@Configuration(proxyBeanMethods = false)
	@ImportResource("cn/taketoday/framework/autoconfigure/condition/factorybean.xml")
	...
	static class ConditionalOnIgnoredSubclassByName {
		...
		@ConditionalOnMissingBean(value = ExampleBean.class,
				ignoredType = "cn.taketoday.framework.autoconfigure.condition.ConditionalOnMissingBeanTests$CustomExampleBean")
		ExampleBean exampleBean() {
			return new ExampleBean("test");
		}
