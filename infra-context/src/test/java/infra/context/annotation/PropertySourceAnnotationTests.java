...
class PropertySourceAnnotationTests {
  ...
  void withImplicitName() {
    ...
    String name = "class path resource [infra/context/annotation/p1.properties]";
  ...
  void withResolvablePlaceholder() {
    System.setProperty("path.to.properties", "infra/context/annotation");
  ...
  void withRepeatedPropertySourcesOnComposedAnnotation() {
    ...
    System.setProperty(key, "infra/context/annotation");
    try (ConfigurableApplicationContext ctx = new AnnotationConfigApplicationContext(configClass)) {
  ...
  @Configuration
  @PropertySource("classpath:${unresolvable:infra/context/annotation}/p1.properties")
  ...
  @Configuration
  @PropertySource(name = "p1", value = "classpath:infra/context/annotation/p1.properties")
  ...
  @Configuration
  @PropertySource(name = "p1", value = "classpath:infra/context/annotation/p1.properties")
  @ComponentScan("infra.context.annotation.spr12111")
  ...
  @Configuration
  @PropertySource("classpath:infra/context/annotation/p2.properties")
  static class P2Config {
  }

  @Configuration
  @PropertySource(value = "classpath:infra/context/annotation/p2.properties", factory = MyCustomFactory.class)
  static class WithCustomFactory {
  }

  @Configuration
  @MyPropertySource("classpath:infra/context/annotation/p2.properties")
  ...
  static class MyCustomFactory implements PropertySourceFactory {
    ...
    @Override
    public infra.core.env.PropertySource<?> createPropertySource(String name, EncodedResource resource) throws IOException {
      Properties props = PropertiesUtils.loadProperties(resource);
      return new infra.core.env.PropertySource<>("my" + name, props) {
        @Override
  ...
  @PropertySource(
          name = "psName",
          value = {
                  "classpath:infra/context/annotation/p1.properties",
                  "classpath:infra/context/annotation/p2.properties"
          })
  ...
  @PropertySource("classpath:infra/context/annotation/p2.properties")
  @PropertySources({
          @PropertySource("classpath:infra/context/annotation/p3.properties"),
  })
  ...
  @PropertySource23
  @PropertySources({
          @PropertySource("classpath:infra/context/annotation/p4.properties")
  })
  @PropertySource("classpath:infra/context/annotation/p5.properties")
  ...
  @Configuration
  @PropertySources({
          @PropertySource(name = "psName", value = "classpath:infra/context/annotation/p1.properties"),
          @PropertySource(name = "psName", value = "classpath:infra/context/annotation/p2.properties"),
  })
  ...
  @PropertySources({
          @PropertySource(name = "psName", value = "classpath:infra/context/annotation/p1.properties"),
          @PropertySource(name = "psName", value = "classpath:infra/context/annotation/missing.properties"),
          @PropertySource(name = "psName", value = "classpath:infra/context/annotation/p2.properties")
  })
  ...
  @PropertySources({
          @PropertySource(name = "psName", value = "classpath:infra/context/annotation/p1.properties"),
          @PropertySource(name = "psName", value = "classpath:infra/context/annotation/missing.properties", ignoreResourceNotFound = true),
  ...
  @PropertySource({
          "classpath:infra/context/annotation/p1.properties",
          "classpath:infra/context/annotation/p2.properties",
          "classpath:infra/context/annotation/p3.properties",
          "classpath:infra/context/annotation/p4.properties"
  })
