...
/**
 * Tests for {@link infra.web.config.ErrorMvcAutoConfiguration}.
 *
 * @author Brian Clozel
...
class ErrorMvcAutoConfigurationTests {
  ...
  private final ApplicationContextRunner contextRunner = ApplicationContextRunner.forProvider(() -> {
          ...
          .withConfiguration(AutoConfigurations.of(infra.web.config.WebMvcAutoConfiguration.class, infra.web.config.ErrorMvcAutoConfiguration.class));
