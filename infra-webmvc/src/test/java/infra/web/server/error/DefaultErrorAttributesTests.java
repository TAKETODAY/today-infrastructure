...
/**
 * Tests for {@link infra.web.server.error.DefaultErrorAttributes}.
 *
 * @author Phillip Webb
 * @author Vedran Pavic
...
class DefaultErrorAttributesTests {
  ...
  void includeTimeStamp() {
    Map<String, Object> attributes = this.errorAttributes.getErrorAttributes(this.webRequest,
            infra.web.server.error.ErrorAttributeOptions.defaults());
  ...
  void mvcError() {
    ...
    var attributes = errorAttributes.getErrorAttributes(webRequest, infra.web.server.error.ErrorAttributeOptions.of(Include.MESSAGE));
  ...
  void mockErrorWithMessage() {
    ...
    Map<String, Object> attributes = this.errorAttributes.getErrorAttributes(this.webRequest,
            infra.web.server.error.ErrorAttributeOptions.of(Include.MESSAGE));
  ...
  void withBindingErrors() {
    ...
    testBindingResult(bindingResult, ex, infra.web.server.error.ErrorAttributeOptions.of(Include.MESSAGE, Include.BINDING_ERRORS));
  }
  ...
  void withoutBindingErrors() {
    ...
    bindingResult.addError(new ObjectError("c", "d"));
    Exception ex = new BindException(bindingResult);
    testBindingResult(bindingResult, ex, infra.web.server.error.ErrorAttributeOptions.defaults());
  }
  ...
  private void testBindingResult(BindingResult bindingResult, Exception ex, infra.web.server.error.ErrorAttributeOptions options) {
    this.request.setAttribute(WebUtils.ERROR_EXCEPTION_ATTRIBUTE, ex);
  ...
  void withExceptionAttribute() {
    infra.web.server.error.DefaultErrorAttributes errorAttributes = new infra.web.server.error.DefaultErrorAttributes();
    RuntimeException ex = new RuntimeException("Test");
    this.request.setAttribute(WebUtils.ERROR_EXCEPTION_ATTRIBUTE, ex);
    Map<String, Object> attributes = errorAttributes.getErrorAttributes(this.webRequest,
            infra.web.server.error.ErrorAttributeOptions.of(Include.EXCEPTION, Include.MESSAGE));
  ...
  void withStackTraceAttribute() {
    ...
    this.request.setAttribute(WebUtils.ERROR_EXCEPTION_ATTRIBUTE, ex);
    Map<String, Object> attributes = this.errorAttributes.getErrorAttributes(this.webRequest,
            infra.web.server.error.ErrorAttributeOptions.of(Include.STACK_TRACE));
  ...
  void shouldIncludePath() {
    request.setRequestURI("path");
    Map<String, Object> attributes = this.errorAttributes.getErrorAttributes(this.webRequest,
            infra.web.server.error.ErrorAttributeOptions.of(Include.PATH));
  ...
  void shouldExcludePath() {
    ...
    Map<String, Object> attributes = this.errorAttributes.getErrorAttributes(this.webRequest,
            infra.web.server.error.ErrorAttributeOptions.of());
  ...
  void whenGetMessageIsOverriddenThenMessageAttributeContainsValueReturnedFromIt() {
    ...
    }.getErrorAttributes(this.webRequest, infra.web.server.error.ErrorAttributeOptions.of(Include.MESSAGE));
  ...
  void extractBindingResultErrorsThatCausedAResponseStatusException() throws Exception {
    ...
    Map<String, Object> attributes = errorAttributes.getErrorAttributes(webRequest, infra.web.server.error.ErrorAttributeOptions.of(Include.MESSAGE, Include.BINDING_ERRORS));
