...
class DefaultErrorViewResolverTests {
  ...
  private infra.web.server.error.DefaultErrorViewResolver resolver;
  ...
  void setup() {
    ...
    this.resolver = new infra.web.server.error.DefaultErrorViewResolver(applicationContext, this.resourcesProperties.staticLocations,
            templateAvailabilityProviders);
  }

  @Test
  void createWhenApplicationContextIsNullShouldThrowException() {
    assertThatIllegalArgumentException().isThrownBy(() -> new infra.web.server.error.DefaultErrorViewResolver(null, new Resources().staticLocations))
  ...
  void createWhenResourcePropertiesIsNullShouldThrowException() {
    assertThatIllegalArgumentException()
            .isThrownBy(() -> new infra.web.server.error.DefaultErrorViewResolver(mock(ApplicationContext.class), null))
