...
class ClientHttpConnectorTests {
  ...
  @MethodSource("infra.http.reactive.client.ClientHttpConnectorTests#methodsWithConnectors")
  void basic(infra.http.reactive.client.ClientHttpConnector connector, HttpMethod method) throws Exception {
  ...
  void errorInRequestBody(infra.http.reactive.client.ClientHttpConnector connector) {
  ...
  @ParameterizedConnectorTest
  void cancelResponseBody(infra.http.reactive.client.ClientHttpConnector connector) {
  ...
  @ParameterizedConnectorTest
  void cookieExpireValueSetAsMaxAge(infra.http.reactive.client.ClientHttpConnector connector) {
  ...
  @ParameterizedConnectorTest
  void partitionedCookieSupport(infra.http.reactive.client.ClientHttpConnector connector) {
  ...
  void disableCookieWithHttpComponents() {
    infra.http.reactive.client.ClientHttpConnector connector = new HttpComponentsClientHttpConnector(
  ...
  @MethodSource("infra.http.reactive.client.ClientHttpConnectorTests#connectors")
  public @interface ParameterizedConnectorTest {
  }

  static List<Named<infra.http.reactive.client.ClientHttpConnector>> connectors() {
  ...
  static List<Arguments> methodsWithConnectors() {
    ...
    for (Named<infra.http.reactive.client.ClientHttpConnector> connector : connectors()) {
