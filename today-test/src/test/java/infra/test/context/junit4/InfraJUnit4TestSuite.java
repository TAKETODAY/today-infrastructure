...
import infra.test.context.junit4.annotation.AnnotationConfigJUnit4ClassRunnerAppCtxTests;
import infra.test.context.junit4.annotation.BeanOverridingDefaultConfigClassesInheritedTests;
import infra.test.context.junit4.annotation.BeanOverridingExplicitConfigClassesInheritedTests;
import infra.test.context.junit4.annotation.DefaultConfigClassesBaseTests;
import infra.test.context.junit4.annotation.DefaultConfigClassesInheritedTests;
import infra.test.context.junit4.annotation.DefaultLoaderBeanOverridingDefaultConfigClassesInheritedTests;
import infra.test.context.junit4.annotation.DefaultLoaderBeanOverridingExplicitConfigClassesInheritedTests;
import infra.test.context.junit4.annotation.DefaultLoaderDefaultConfigClassesBaseTests;
import infra.test.context.junit4.annotation.DefaultLoaderDefaultConfigClassesInheritedTests;
import infra.test.context.junit4.annotation.DefaultLoaderExplicitConfigClassesBaseTests;
import infra.test.context.junit4.annotation.DefaultLoaderExplicitConfigClassesInheritedTests;
import infra.test.context.junit4.annotation.ExplicitConfigClassesBaseTests;
import infra.test.context.junit4.annotation.ExplicitConfigClassesInheritedTests;
import infra.test.context.junit4.profile.annotation.DefaultProfileAnnotationConfigTests;
import infra.test.context.junit4.profile.annotation.DevProfileAnnotationConfigTests;
import infra.test.context.junit4.profile.annotation.DevProfileResolverAnnotationConfigTests;
import infra.test.context.junit4.profile.xml.DefaultProfileXmlConfigTests;
import infra.test.context.junit4.profile.xml.DevProfileResolverXmlConfigTests;
import infra.test.context.junit4.profile.xml.DevProfileXmlConfigTests;
