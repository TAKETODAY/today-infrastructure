...
import static infra.jdbc.datasource.init.ScriptUtils.DEFAULT_BLOCK_COMMENT_END_DELIMITER;
import static infra.jdbc.datasource.init.ScriptUtils.DEFAULT_BLOCK_COMMENT_START_DELIMITER;
import static infra.jdbc.datasource.init.ScriptUtils.DEFAULT_COMMENT_PREFIXES;
import static infra.jdbc.datasource.init.ScriptUtils.DEFAULT_STATEMENT_SEPARATOR;
import static infra.test.context.jdbc.SqlConfig.ErrorMode.CONTINUE_ON_ERROR;
import static infra.test.context.jdbc.SqlConfig.ErrorMode.FAIL_ON_ERROR;
import static infra.test.context.jdbc.SqlConfig.ErrorMode.IGNORE_FAILED_DROPS;
import static infra.test.context.jdbc.SqlConfig.TransactionMode.INFERRED;
import static infra.test.context.jdbc.SqlConfig.TransactionMode.ISOLATED;
