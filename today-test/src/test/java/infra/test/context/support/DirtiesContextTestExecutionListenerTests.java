...
import static infra.test.annotation.DirtiesContext.ClassMode.BEFORE_CLASS;
import static infra.test.annotation.DirtiesContext.ClassMode.BEFORE_EACH_TEST_METHOD;
import static infra.test.annotation.DirtiesContext.HierarchyMode.CURRENT_LEVEL;
import static infra.test.annotation.DirtiesContext.HierarchyMode.EXHAUSTIVE;
