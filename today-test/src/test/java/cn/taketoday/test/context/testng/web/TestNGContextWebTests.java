 ...
 * {@link WebApplicationContext} when extending {@link AbstractTestNGContextTests}.
 *
 * @author Sam Brannen
 * @since 4.0
 */
...
@WebAppConfiguration
public class TestNGContextWebTests extends AbstractTestNGContextTests implements ServletContextAware {
  ...
  public void basicWacFeatures() throws Exception {
    ...
    assertThat(rootWac)
            .as("Root WAC must be stored in the ServletContext as: " + WebServletApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE)
            .isNotNull();
