...
public class AnnotationConfigTransactionalTestNGContextTests
        extends AbstractTransactionalTestNGContextTests {
  ...
  static class ContextConfiguration {
    ...
    DataSource dataSource() {
      return new EmbeddedDatabaseBuilder()//
              ...
              .addScript("classpath:/cn/taketoday/test/jdbc/data.sql")//
              .build();
    }
