...
import static cn.taketoday.test.context.support.ContextLoaderUtils.GENERATED_CONTEXT_HIERARCHY_LEVEL_PREFIX;
import static cn.taketoday.test.context.support.ContextLoaderUtils.buildContextHierarchyMap;
import static cn.taketoday.test.context.support.ContextLoaderUtils.resolveContextHierarchyAttributes;
...
class ContextLoaderUtilsContextHierarchyTests extends AbstractContextConfigurationUtilsTests {
   ...
   * Used to reproduce bug reported in https://jira.spring.io/browse/SPR-10997
   */
  private static class DummyApplicationContextInitializer implements ApplicationContextInitializer {
