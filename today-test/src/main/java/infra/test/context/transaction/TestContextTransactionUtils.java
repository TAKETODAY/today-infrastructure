...
import infra.transaction.interceptor.DelegatingTransactionAttribute;
...
public abstract class TestContextTransactionUtils {
   ...
   * the {@link infra.context.ApplicationContext ApplicationContext}
   ...
   * from the {@link infra.context.ApplicationContext ApplicationContext}
   * of the supplied test context:
   * <ol>
