...
public interface SmartContextLoader extends ContextLoader {
   ...
   * {@link Environment Environment} (see
   * {@link MergedContextConfiguration#getActiveProfiles()}).</li>
   * <li>Add test {@link PropertySource PropertySources}
   ...
   * {@link TestPropertySourceUtils
   * TestPropertySourceUtils}).</li>
   * <li>Invoke {@link infra.context.ApplicationContextInitializer
