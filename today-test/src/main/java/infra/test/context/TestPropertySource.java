...
import infra.test.context.web.AbstractGenericWebContextLoader;
 ...
 * {@link infra.context.ApplicationContextInitializer ApplicationContextInitializer}
...
public @interface TestPropertySource {
   ...
   * {@link Resource Resource}. A plain path
   ...
   * {@link ResourceUtils#FILE_URL_PREFIX file:},
   * {@code http:}, etc.) will be loaded using the specified resource protocol.
   * <p>Property placeholders in paths (i.e., <code>${...}</code>) will be
   * {@linkplain Environment#resolveRequiredPlaceholders(String)
   ...
   * {@link Environment Environment} before the
