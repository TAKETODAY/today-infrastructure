...
public @interface SqlConfig {
  ...
  /**
   * The bean name of the {@link infra.transaction.PlatformTransactionManager
   ...
   * <li>{@link infra.transaction.annotation.TransactionManagementConfigurer
   ...
   * {@code "\n"} as a last resort.
   * <p>May be set to
   * {@link ScriptUtils#EOF_STATEMENT_SEPARATOR}
   ...
   *
   * @see ScriptUtils#DEFAULT_COMMENT_PREFIXES
   * @see #commentPrefix
   * @since 4.0
   */
