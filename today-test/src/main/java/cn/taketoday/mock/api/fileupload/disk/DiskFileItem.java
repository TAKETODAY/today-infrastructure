 ...
 */
package cn.taketoday.mock.api.fileupload.disk;
...
import cn.taketoday.mock.api.fileupload.DeferredFileOutputStream;
...
import cn.taketoday.mock.api.fileupload.IOUtils;
import cn.taketoday.mock.api.fileupload.ParameterParser;
import cn.taketoday.mock.api.fileupload.util.Streams;
 ...
 * cn.taketoday.mock.api.fileupload.FileUpload FileUpload} instance (see
 * {@link cn.taketoday.mock.api.fileupload.FileUpload
 * #parseRequest(cn.taketoday.mock.api.fileupload.RequestContext)}), you
...
public class DiskFileItem
   ...
   * @throws cn.taketoday.mock.api.fileupload.InvalidFileNameException The file name contains a NUL character, which might be an indicator of
   * a security attack. If you intend to use the file name anyways, catch
   * the exception and use {@link
   * cn.taketoday.mock.api.fileupload.InvalidFileNameException#getName()}.
   */
  @Override
