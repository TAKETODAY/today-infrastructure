 ...
 *
 * @see MockRequestAttributeListener
 */
public class MockRequestAttributeEvent extends MockRequestEvent {
   ...
   */
  public MockRequestAttributeEvent(MockContext sc, MockRequest request, String name, Object value) {
    super(sc, request);
    this.name = name;
    this.value = value;
  }
