...
public @interface SqlConfig {
   ...
   * </ol>
   *
   * @see TestContextTransactionUtils#retrieveDataSource
   */
  String dataSource() default "";

  /**
   * The bean name of the {@link cn.taketoday.transaction.PlatformTransactionManager
   ...
   * <li>{@link cn.taketoday.transaction.annotation.TransactionManagementConfigurer
   ...
   * </ol>
   *
   * @see TestContextTransactionUtils#retrieveTransactionManager
   */
   ...
   * {@code "\n"} as a last resort.
   * <p>May be set to
   * {@link cn.taketoday.jdbc.datasource.init.ScriptUtils#EOF_STATEMENT_SEPARATOR}
   * to signal that each script contains a single statement without a
   * separator.
   *
   * @see cn.taketoday.jdbc.datasource.init.ScriptUtils#DEFAULT_STATEMENT_SEPARATOR
   * @see cn.taketoday.jdbc.datasource.init.ScriptUtils#EOF_STATEMENT_SEPARATOR
   */
   ...
   *
   * @see cn.taketoday.jdbc.datasource.init.ScriptUtils#DEFAULT_COMMENT_PREFIX
   * @see #commentPrefixes
   */
   ...
   * @see cn.taketoday.jdbc.datasource.init.ScriptUtils#DEFAULT_BLOCK_COMMENT_START_DELIMITER
   */
   ...
   * @see cn.taketoday.jdbc.datasource.init.ScriptUtils#DEFAULT_BLOCK_COMMENT_END_DELIMITER
   */
  ...
  enum TransactionMode {
     ...
     * {@link TestContextTransactionUtils TestContextTransactionUtils}
     ...
     * {@link TransactionalTestExecutionListener TransactionalTestExecutionListener}.
     * </ul>
     * </ol>
     *
     * @see #ISOLATED
