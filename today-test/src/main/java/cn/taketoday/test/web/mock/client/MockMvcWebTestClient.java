...
import cn.taketoday.test.web.mock.setup.StandaloneMockMvcBuilder;
...
public interface MockMvcWebTestClient {
   ...
   * {@link cn.taketoday.test.web.mock.setup.MockMvcBuilders#standaloneSetup(Object...)}.
   ...
   * controllers.
   * <p>Internally this is delegated to and equivalent to using
   * {@link cn.taketoday.test.web.mock.setup.MockMvcBuilders#webAppContextSetup(cn.taketoday.context.ApplicationContext)}
