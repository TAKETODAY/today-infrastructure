...
import cn.taketoday.web.mock.GenericServlet;
...
public abstract class HttpServlet extends GenericServlet {
  ...
  public static final String LEGACY_DO_HEAD = "cn.taketoday.web.mock.http.legacyDoHead";
   ...
   * {@link cn.taketoday.web.mock.Servlet#service} method. There's no need to override this method.
   *
   * @param req the {@link HttpServletRequest} object that contains the request the client made of the servlet
   * @param resp the {@link HttpServletResponse} object that contains the response the servlet returns to the client
   * @throws IOException if an input or output error occurs while the servlet is handling the HTTP request
   * @throws ServletException if the HTTP request cannot be handled
   * @see cn.taketoday.web.mock.Servlet#service
   */
...
class NoBodyResponse extends HttpServletResponseWrapper {
  ...
  private static final ResourceBundle lStrings = ResourceBundle.getBundle("cn.taketoday.web.mock.http.LocalStrings");
