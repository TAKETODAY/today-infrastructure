...
import cn.taketoday.web.mock.fileupload.DeferredFileOutputStream;
...
import cn.taketoday.web.mock.fileupload.ParameterParser;
import cn.taketoday.web.mock.fileupload.util.Streams;
 ...
 * cn.taketoday.web.mock.fileupload.FileUpload FileUpload} instance (see
 * {@link cn.taketoday.web.mock.fileupload.FileUpload
 * #parseRequest(cn.taketoday.web.mock.fileupload.RequestContext)}), you
...
public class DiskFileItem
   ...
   * @throws cn.taketoday.web.mock.fileupload.InvalidFileNameException The file name contains a NUL character, which might be an indicator of
   * a security attack. If you intend to use the file name anyways, catch
   * the exception and use {@link
   * cn.taketoday.web.mock.fileupload.InvalidFileNameException#getName()}.
   */
  @Override
