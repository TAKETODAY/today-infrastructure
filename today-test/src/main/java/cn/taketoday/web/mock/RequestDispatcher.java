...
public interface RequestDispatcher {
   ...
   * @since Servlet 3.0
   */
  static final String FORWARD_REQUEST_URI = "cn.taketoday.web.mock.forward.request_uri";
   ...
   * @since Servlet 3.0
   */
  static final String FORWARD_CONTEXT_PATH = "cn.taketoday.web.mock.forward.context_path";
   ...
   * @since Servlet 4.0
   */
  static final String FORWARD_MAPPING = "cn.taketoday.web.mock.forward.mapping";
   ...
   * @since Servlet 3.0
   */
  static final String FORWARD_PATH_INFO = "cn.taketoday.web.mock.forward.path_info";
   ...
   * @since Servlet 3.0
   */
  static final String FORWARD_SERVLET_PATH = "cn.taketoday.web.mock.forward.servlet_path";
   ...
   * @since Servlet 3.0
   */
  static final String FORWARD_QUERY_STRING = "cn.taketoday.web.mock.forward.query_string";
   ...
   * @since Servlet 3.0
   */
  static final String INCLUDE_REQUEST_URI = "cn.taketoday.web.mock.include.request_uri";
   ...
   * @since Servlet 3.0
   */
  static final String INCLUDE_CONTEXT_PATH = "cn.taketoday.web.mock.include.context_path";
   ...
   * @since Servlet 3.0
   */
  static final String INCLUDE_PATH_INFO = "cn.taketoday.web.mock.include.path_info";
   ...
   * @since Servlet 4.0
   */
  static final String INCLUDE_MAPPING = "cn.taketoday.web.mock.include.mapping";
   ...
   * @since Servlet 3.0
   */
  static final String INCLUDE_SERVLET_PATH = "cn.taketoday.web.mock.include.servlet_path";
   ...
   * @since Servlet 3.0
   */
  static final String INCLUDE_QUERY_STRING = "cn.taketoday.web.mock.include.query_string";
   ...
   * @since Servlet 3.0
   */
  public static final String ERROR_EXCEPTION = "cn.taketoday.web.mock.error.exception";
   ...
   * @since Servlet 3.0
   */
  public static final String ERROR_EXCEPTION_TYPE = "cn.taketoday.web.mock.error.exception_type";
   ...
   * @since Servlet 3.0
   */
  public static final String ERROR_MESSAGE = "cn.taketoday.web.mock.error.message";
   ...
   * @since Servlet 3.0
   */
  public static final String ERROR_REQUEST_URI = "cn.taketoday.web.mock.error.request_uri";
   ...
   * @since Servlet 3.0
   */
  public static final String ERROR_SERVLET_NAME = "cn.taketoday.web.mock.error.servlet_name";
   ...
   * @since Servlet 3.0
   */
  public static final String ERROR_STATUS_CODE = "cn.taketoday.web.mock.error.status_code";
