...
public class EntityMetadata {
  ...
  private final Identifier[] columnNames;

  /** Column names of {@link #entityPropertiesExcludeId}, excluding the ID column. */
  private final Identifier[] columnNamesExcludeId;
  ...
  protected EntityMetadata(BeanMetadata beanMetadata, Class<?> entityClass, Identifier tableName,
    ...
    if (idProperty != null) {
      int idIndex = entityProperties.indexOf(idProperty);
      entityProperties.remove(idProperty);
      columnNames.remove(idIndex);
    }

    this.autoGeneratedId = determineGeneratedId(idProperty);
    this.columnNamesExcludeId = columnNames.toArray(new Identifier[0]);
   ...
   */
  public @Nullable Identifier getIdColumnName() {
