 ...
 */
public final class NoConditionsQuery extends SimpleSelectQueryStatement implements QueryCondition, DebugDescriptive {

  public static final NoConditionsQuery instance = new NoConditionsQuery();
