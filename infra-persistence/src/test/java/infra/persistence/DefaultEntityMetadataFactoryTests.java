...
class DefaultEntityMetadataFactoryTests {
  ...
  void nullId() {
    ...
    assertThat(entityMetadata.getIdProperty()).isNull();
    assertThat(entityMetadata.getIdColumnName()).isNull();
    assertThat(entityMetadata.isAutoGeneratedId()).isFalse();
  ...
  void autoGeneratedId() {
    ...
    assertThat(entityMetadata.getIdProperty()).isNotNull();
    assertThat(entityMetadata.getIdColumnName()).isNotNull().extracting(Identifier::getText).isEqualTo("id_");
    assertThat(entityMetadata.isAutoGeneratedId()).isTrue();
    assertThat(entityMetadata).isNotEqualTo(factory.getEntityMetadata(UserModel.class));
  }
  ...
  void entityRefId() {
    ...
    assertThat(metadata.getTableName().getText()).isEqualTo("t_user");
    assertThat(metadata.isAutoGeneratedId()).isFalse();
    assertThat(metadata.findIdProperty()).isSameAs(factory.getEntityMetadata(UserModel.class).getIdProperty());
  ...
  void shouldHandleTableNameGenerator() {
    ...
    EntityMetadata metadata = factory.createEntityMetadata(UserModel.class);
    assertThat(metadata.getTableName().getText()).isEqualTo(customTableName);
  }
  ...
  void shouldHandleIdPropertyDiscover() {
    ...
    assertThat(metadata.getIdProperty()).isNotNull();
    assertThat(metadata.getIdProperty().getBeanProperty().getName()).isEqualTo("identifier");
    assertThat(metadata).isNotEqualTo(factory.getEntityMetadata(UserModel.class));
  }
  ...
  void shouldHandleIdAnnotationDiscovery() {
    ...
    assertThat(metadata.getIdProperty()).isNotNull();
    assertThat(metadata.getIdProperty().getBeanProperty().getName()).isEqualTo("identifier");
    assertThat(metadata.getIdColumnName()).isNotNull();
    assertThat(metadata).isNotEqualTo(factory.getEntityMetadata(UserModel.class));
  }
  ...
  void shouldHandleColumnAnnotationDiscovery() {
    ...
    assertThat(nameProperty.getColumnName().getText()).isEqualTo("user_name");
    assertThat(metadata).isNotEqualTo(factory.getEntityMetadata(UserModel.class));
  }
  ...
  void shouldHandleCamelCaseToUnderscoreConversion() {
    ...
    assertThat(userNameProperty.getColumnName().getText()).isEqualTo("user_name");

    EntityProperty firstNameProperty = metadata.findProperty("firstName");
    assertThat(firstNameProperty.getColumnName().getText()).isEqualTo("first_name");

    EntityProperty lastNameProperty = metadata.findProperty("lastName");
    assertThat(lastNameProperty.getColumnName().getText()).isEqualTo("last_name");
    assertThat(metadata).isNotEqualTo(factory.getEntityMetadata(UserModel.class));
  }
  ...
  void shouldHandleGeneratedIdAnnotation() {
    ...
    assertThat(metadata.isAutoGeneratedId()).isTrue();
    assertThat(metadata.getIdProperty().isPresent(GeneratedId.class)).isTrue();
    assertThat(metadata).isNotEqualTo(factory.getEntityMetadata(UserModel.class));
  }
