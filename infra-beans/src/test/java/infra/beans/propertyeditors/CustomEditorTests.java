...
import infra.beans.BooleanTestBean;
import infra.beans.NumberTestBean;
...
class CustomEditorTests {
  ...
  void classEditorWithArray() {
    PropertyEditor classEditor = new ClassEditor();
    classEditor.setAsText("infra.beans.testfixture.beans.TestBean[]");
    assertThat(classEditor.getValue()).isEqualTo(TestBean[].class);
    assertThat(classEditor.getAsText()).isEqualTo("infra.beans.testfixture.beans.TestBean[]");
  }
