...
import infra.jdbc.config.DataSourcePoolMetadataProvidersConfiguration;
...
/**
 * Tests for {@link infra.jdbc.config.health.DataSourceHealthContributorAutoConfiguration}.
 *
 * @author Phillip Webb
 * @author Julio Gomez
...
class DataSourceHealthContributorAutoConfigurationTests {
  ...
  private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
          .withConfiguration(AutoConfigurations.of(DataSourceAutoConfiguration.class,
                  HealthContributorAutoConfiguration.class, infra.jdbc.config.health.DataSourceHealthContributorAutoConfiguration.class));
