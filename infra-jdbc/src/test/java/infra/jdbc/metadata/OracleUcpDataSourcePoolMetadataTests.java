...
/**
 * Tests for {@link infra.jdbc.metadata.OracleUcpDataSourcePoolMetadata}.
 *
 * @author Fabio Grassi
 */
class OracleUcpDataSourcePoolMetadataTests
        extends AbstractDataSourcePoolMetadataTests<infra.jdbc.metadata.OracleUcpDataSourcePoolMetadata> {

  private final infra.jdbc.metadata.OracleUcpDataSourcePoolMetadata dataSourceMetadata = new infra.jdbc.metadata.OracleUcpDataSourcePoolMetadata(
          createDataSource(0, 2));

  @Override
  protected infra.jdbc.metadata.OracleUcpDataSourcePoolMetadata getDataSourceMetadata() {
  ...
  void getValidationQuery() throws SQLException {
    ...
    assertThat(new infra.jdbc.metadata.OracleUcpDataSourcePoolMetadata(dataSource).getValidationQuery())
  ...
  void getDefaultAutoCommit() throws SQLException {
    ...
    assertThat(new infra.jdbc.metadata.OracleUcpDataSourcePoolMetadata(dataSource).getDefaultAutoCommit()).isFalse();
  }
