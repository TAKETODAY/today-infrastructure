...
class IssuesTests extends AbstractRepositoryManagerTests {
  ...
  public void testForNpeInRowGet(DbType dbType, RepositoryManager sql2o) {
    sql2o.createNamedQuery("create table issue4table(id int generated by default as identity primary key, val varchar(20))").executeUpdate();
  ...
  void testForNullToSimpeType(DbType dbType, RepositoryManager sql2o) {
    sql2o.createNamedQuery("create table issue5table(id int generated by default as identity primary key, val integer)").executeUpdate();
  ...
  void testForLabelErrorInHsqlDb(DbType dbType, RepositoryManager sql2o) {
    sql2o.createNamedQuery("create table issue9test (id int generated by default as identity primary key, val varchar(50))").executeUpdate();
  ...
  void testForNullPointerExceptionInAddParameterMethod(DbType dbType, RepositoryManager sql2o) {
    sql2o.createNamedQuery("create table issue11test (id int generated by default as identity primary key, val varchar(50), adate date)")
            .executeUpdate();
