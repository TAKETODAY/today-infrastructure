 ...
 * <em>Infra TestContext Framework</em>, in the {@code infra-test} artifact.
 *
...
public interface JdbcOperations {
   ...
   * @see GeneratedKeyHolder
   */
  int[] batchUpdate(PreparedStatementCreator psc,
          BatchPreparedStatementSetter pss, KeyHolder generatedKeyHolder) throws DataAccessException;
