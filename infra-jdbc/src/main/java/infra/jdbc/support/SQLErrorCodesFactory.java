...
public class SQLErrorCodesFactory {
   ...
   */
  public static final String SQL_ERROR_CODE_DEFAULT_PATH = "infra/jdbc/support/sql-error-codes.xml";
  ...
  protected SQLErrorCodesFactory() {
    ...
    try {
      ...
      if (resource != null && resource.exists()) {
        ...
        log.info("Default sql-error-codes.xml not found (should be included in infra-jdbc jar)");
      }
