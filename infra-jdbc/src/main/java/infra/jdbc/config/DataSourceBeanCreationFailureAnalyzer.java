...
import infra.jdbc.config.DataSourceProperties.DataSourceBeanCreationException;
import infra.util.ObjectUtils;
import infra.util.StringUtils;

/**
 * An {@link AbstractFailureAnalyzer} for failures caused by a
 * {@link infra.jdbc.config.DataSourceProperties.DataSourceBeanCreationException}.
 *
