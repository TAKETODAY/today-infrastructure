  ...
  void bindWhenEnumParameterWithEmptyDefaultValueShouldThrowException() {
    assertThatExceptionOfType(BindException.class)
            ...
            .withStackTraceContaining(
                    "Parameter of type infra.context.properties.bind.ValueObjectBinderTests$NestedConstructorBeanWithEmptyDefaultValueForEnumTypes$Foo must have a non-empty default value.");
  }
  ...
  void bindToRecordWithDefaultValue() {
    ...
    String recordProperties = """
            public record RecordProperties(
            	@infra.context.properties.bind.DefaultValue("default-value-1") String property1,
            	@infra.context.properties.bind.DefaultValue("default-value-2") String property2) {
            }
            """;
