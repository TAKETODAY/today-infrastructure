...
import infra.logging.LoggerGroups;
...
import infra.logging.java.JavaLoggingSystem;
...
class LoggingApplicationListenerTests {
  ...
  @Test
  void parseLevels() {
    addPropertiesToEnvironment(this.context, "logging.level.infra=TRACE");
    this.listener.initialize(this.context.getEnvironment(), this.context.getClassLoader());
    this.logger.debug("testatdebug");
    this.logger.trace("testattrace");
    assertThat(this.output).contains("testatdebug");
  ...
  void parseLevelsWithPlaceholder() {
    addPropertiesToEnvironment(this.context, "foo=TRACE", "logging.level.infra=${foo}");
    this.listener.initialize(this.context.getEnvironment(), this.context.getClassLoader());
    this.logger.debug("testatdebug");
    this.logger.trace("testattrace");
    assertThat(this.output).contains("testatdebug");
  ...
  void parseLevelsFails() {
    ...
    addPropertiesToEnvironment(this.context, "logging.level.infra=GARBAGE");
  ...
  void parseLevelsNone() {
    addPropertiesToEnvironment(this.context, "logging.level.infra=OFF");
    this.listener.initialize(this.context.getEnvironment(), this.context.getClassLoader());
    this.logger.debug("testatdebug");
  ...
  void parseLevelsMapsFalseToOff() {
    addPropertiesToEnvironment(this.context, "logging.level.infra=false");
    this.listener.initialize(this.context.getEnvironment(), this.context.getClassLoader());
    this.logger.debug("testatdebug");
    this.logger.error("testaterror");
    assertThat(this.output).doesNotContain("testatdebug").doesNotContain("testaterror");
  ...
  void loggingGroupsDefaultsAreApplied() {
    ...
    this.listener.initialize(this.context.getEnvironment(), this.context.getClassLoader());
    assertTraceEnabled("infra.core", false);
