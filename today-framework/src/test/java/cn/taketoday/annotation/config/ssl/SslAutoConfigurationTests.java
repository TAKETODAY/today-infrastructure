...
class SslAutoConfigurationTests {
  ...
  void sslBundlesCreatedWithCertificates() {
    ...
    propertyValues.add(
            "ssl.bundle.pem.first.keystore.certificate=classpath:cn/taketoday/annotation/config/ssl/rsa-cert.pem");
    propertyValues.add(
            "ssl.bundle.pem.first.keystore.private-key=classpath:cn/taketoday/annotation/config/ssl/rsa-key.pem");
    ...
    propertyValues.add(
            "ssl.bundle.pem.first.truststore.certificate=classpath:cn/taketoday/annotation/config/ssl/rsa-cert.pem");
    propertyValues.add(
            "ssl.bundle.pem.first.truststore.private-key=classpath:cn/taketoday/annotation/config/ssl/rsa-key.pem");
    propertyValues.add("ssl.bundle.pem.second.key.alias=alias2");
    propertyValues.add("ssl.bundle.pem.second.key.password=secret2");
    propertyValues.add(
            "ssl.bundle.pem.second.keystore.certificate=classpath:cn/taketoday/annotation/config/ssl/ed25519-cert.pem");
    propertyValues.add(
            "ssl.bundle.pem.second.keystore.private-key=classpath:cn/taketoday/annotation/config/ssl/ed25519-key.pem");
    propertyValues.add("ssl.bundle.pem.second.keystore.type=PKCS12");
    propertyValues.add(
            "ssl.bundle.pem.second.truststore.certificate=classpath:cn/taketoday/annotation/config/ssl/ed25519-cert.pem");
    propertyValues.add(
            "ssl.bundle.pem.second.truststore.private-key=classpath:cn/taketoday/annotation/config/ssl/ed25519-key.pem");
