...
import cn.taketoday.context.support.ReloadableResourceBundleMessageSource;
...
class ResourceBundleMessageSourceTests {
  ...
  void reloadableResourceBundleMessageSourceWithInappropriateDefaultCharset() {
    ...
    fileCharsets.setProperty("cn/taketoday/context/support/messages_de", "unicode");
