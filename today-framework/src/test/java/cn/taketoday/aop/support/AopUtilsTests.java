...
public class AopUtilsTests {
  ...
  public void testPointcutCanNeverApply() {
    ...
    Assertions.assertThat(AopUtils.canApply(no, Object.class)).isFalse();
  }

  @Test
  public void testPointcutAlwaysApplies() {
    Assertions.assertThat(AopUtils.canApply(new DefaultPointcutAdvisor(new NopInterceptor()), Object.class)).isTrue();
