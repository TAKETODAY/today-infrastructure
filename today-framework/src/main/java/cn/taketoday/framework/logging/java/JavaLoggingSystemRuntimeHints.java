...
class JavaLoggingSystemRuntimeHints implements RuntimeHintsRegistrar {
  ...
  public void registerHints(RuntimeHints hints, @Nullable ClassLoader classLoader) {
    hints.resources().registerPattern("cn/taketoday/framework/logging/java/logging.properties");
    hints.resources().registerPattern("cn/taketoday/framework/logging/java/logging-file.properties");
  }
