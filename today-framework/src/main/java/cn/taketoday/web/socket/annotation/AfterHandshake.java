...
/**
 * This method level annotation can be used to decorate
 * a Java method that wishes to be called when after handshake
 *
 ...
 *
 * @author dannycoward
 * @author TODAY 2021/5/7 12:40
 * @since 3.0.1
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
public @interface AfterHandshake {
