...
class ServiceConnectionContextCustomizerTests {
  ...
  void setup() {
    ...
    this.annotation = MergedAnnotation.valueOf(ServiceConnection.class,
  ...
  void customizeContextRegistersServiceConnections() {
    ServiceConnectionContextCustomizer customizer = new ServiceConnectionContextCustomizer(List.of(this.source), this.factories);
  ...
  void equalsAndHashCode() {
    ...
    MergedAnnotation<ServiceConnection> annotation1 = MergedAnnotation.valueOf(ServiceConnection.class,
            Map.of("name", "", "type", new Class<?>[0]));
    MergedAnnotation<ServiceConnection> annotation2 = MergedAnnotation.valueOf(ServiceConnection.class,
            Map.of("name", "", "type", new Class<?>[0]));
    MergedAnnotation<ServiceConnection> annotation3 = MergedAnnotation.valueOf(ServiceConnection.class,
