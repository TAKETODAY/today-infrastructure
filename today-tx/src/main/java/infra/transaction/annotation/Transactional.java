 ...
 * annotation, consult the {@link infra.transaction.TransactionDefinition}
 * and {@link infra.transaction.interceptor.TransactionAttribute} javadocs.
 *
 * <h3>Transaction Management</h3>
 *
 * <p>This annotation commonly works with thread-bound transactions managed by a
 * {@link infra.transaction.PlatformTransactionManager}, exposing a
 ...
 * by a {@link infra.transaction.ReactiveTransactionManager} which
 ...
 * @see infra.transaction.interceptor.TransactionAttribute
 * @see infra.transaction.interceptor.DefaultTransactionAttribute
...
public @interface Transactional {
   ...
   * {@link infra.transaction.TransactionManager TransactionManager}
   * bean definition.
   *
   * <p>A type-level bean qualifier annotation with a
   * {@link Qualifier#value() qualifier value}
   ...
   *
   * @see #value
   * @see infra.transaction.PlatformTransactionManager
   ...
   *
   * @see infra.transaction.interceptor.DefaultTransactionAttribute#getLabels()
   */
   ...
   *
   * @see infra.transaction.interceptor.TransactionAttribute#getPropagationBehavior()
   */
   ...
   * isolation level.
   *
   * @see infra.transaction.interceptor.TransactionAttribute#getIsolationLevel()
   * @see infra.transaction.support.AbstractPlatformTransactionManager#setValidateExistingTransaction
   */
   ...
   * @see infra.transaction.interceptor.TransactionAttribute#getTimeout()
   */
   ...
   *
   * @see infra.transaction.interceptor.TransactionAttribute#isReadOnly()
   ...
   * {@link infra.transaction.interceptor.DefaultTransactionAttribute#rollbackOn(Throwable)}
   ...
   * @see infra.transaction.interceptor.RollbackRuleAttribute#RollbackRuleAttribute(Class)
   * @see infra.transaction.interceptor.DefaultTransactionAttribute#rollbackOn(Throwable)
   */
   ...
   *
   * @see #rollbackFor
   * @see infra.transaction.interceptor.RollbackRuleAttribute#RollbackRuleAttribute(String)
   * @see infra.transaction.interceptor.DefaultTransactionAttribute#rollbackOn(Throwable)
   */
   ...
   * @see infra.transaction.interceptor.NoRollbackRuleAttribute#NoRollbackRuleAttribute(Class)
   * @see infra.transaction.interceptor.DefaultTransactionAttribute#rollbackOn(Throwable)
   */
   ...
   *
   * @see #noRollbackFor
   * @see infra.transaction.interceptor.NoRollbackRuleAttribute#NoRollbackRuleAttribute(String)
   * @see infra.transaction.interceptor.DefaultTransactionAttribute#rollbackOn(Throwable)
   */
