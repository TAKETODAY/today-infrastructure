...
public abstract class AbstractPlatformTransactionManager
   ...
   * @see infra.transaction.TransactionDefinition#PROPAGATION_NOT_SUPPORTED
   * @see infra.transaction.TransactionDefinition#PROPAGATION_NEVER
   */
   ...
   *
   * @see infra.transaction.TransactionDefinition#PROPAGATION_REQUIRED
   * @see infra.transaction.TransactionDefinition#PROPAGATION_MANDATORY
   * @see infra.transaction.TransactionDefinition#PROPAGATION_REQUIRES_NEW
   */
   ...
   *
   * @see infra.transaction.TransactionDefinition#TIMEOUT_DEFAULT
   */
   ...
   *
   * @see infra.transaction.UnexpectedRollbackException
   */
  ...
  private TransactionStatus handleExistingTransaction(TransactionDefinition definition, Object transaction)
    ...
    if (definition.getPropagationBehavior() == TransactionDefinition.PROPAGATION_NESTED) {
      ...
      if (useSavepointForNestedTransaction()) {
        // Create savepoint within existing Infra-managed transaction,
        ...
        // Usually only for JTA: Infra synchronization might get activated here
   ...
   * @see infra.transaction.TransactionDefinition#getTimeout()
   ...
   * and {@code rollback}.
   *
   * @see infra.transaction.TransactionStatus#isRollbackOnly()
   * @see #doCommit
   * @see #rollback
   */
  @Override
   ...
   * @throws infra.transaction.CannotCreateTransactionException if transaction support is not available
   ...
   * @throws infra.transaction.NestedTransactionNotSupportedException if the underlying transaction does not support nesting
   */
   ...
   * @throws infra.transaction.TransactionSuspensionNotSupportedException if suspending is not supported by the transaction manager implementation
   * @throws TransactionException in case of system errors
   * @see #doResume
   */
   ...
   * @throws infra.transaction.TransactionSuspensionNotSupportedException if resuming is not supported by the transaction manager implementation
   * @throws TransactionException in case of system errors
   * @see #doSuspend
   */
   ...
   * @see infra.transaction.TransactionStatus#setRollbackOnly()
   * @see infra.transaction.UnexpectedRollbackException
