 ...
 * (for example, a {@link infra.transaction.jta.JtaTransactionManager} instance)
 ...
 *
 * <pre class="code">
 * &lt;bean id="baseTransactionProxy" class="infra.transaction.interceptor.TransactionProxyFactoryBean"
 *     abstract="true"&gt;
