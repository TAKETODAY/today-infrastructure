...
import cn.taketoday.web.mock.annotation.MultipartConfig;
...
public interface HttpServletRequest extends ServletRequest {
   ...
   * <p>
   * The mapping returned depends on the current {@link cn.taketoday.web.mock.DispatcherType} as obtained from
   * {@link #getDispatcherType()}:
   * <dl>
   * <dt>{@link cn.taketoday.web.mock.DispatcherType#REQUEST}, {@link cn.taketoday.web.mock.DispatcherType#ASYNC},
   * {@link cn.taketoday.web.mock.DispatcherType#ERROR}</dt>
   * <dd>Return the mapping for the target of the dispatch i.e. the mapping for the current
   * {@link cn.taketoday.web.mock.Servlet}.</dd>
   *
   * <dt>{@link cn.taketoday.web.mock.DispatcherType#INCLUDE}</dt>
   * <dd>Return the mapping as prior to the current dispatch. i.e the mapping returned is unchanged by a call to</dd>
   * {@link RequestDispatcher#include(ServletRequest, cn.taketoday.web.mock.ServletResponse)}.
   *
   * <dt>{@link cn.taketoday.web.mock.DispatcherType#FORWARD}</dt>
   * <dd>Return the mapping for the target of the dispatch i.e. the mapping for the current
   * {@link cn.taketoday.web.mock.Servlet}, unless the {@link RequestDispatcher} was obtained via
   * {@link cn.taketoday.web.mock.ServletContext#getNamedDispatcher(String)}, in which case return the mapping as prior to the
   * current dispatch. i.e the mapping returned is changed during a call to
   * {@link RequestDispatcher#forward(ServletRequest, cn.taketoday.web.mock.ServletResponse)} only if the dispatcher is not a
   * named dispatcher.</dd>
   * </dl>
   * </p>
   * <p>
