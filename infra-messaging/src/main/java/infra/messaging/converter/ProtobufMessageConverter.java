...
public class ProtobufMessageConverter extends AbstractMessageConverter {
  ...
  @Override
  protected Object convertFromInternal(infra.messaging.Message<?> message,
  ...
  interface ProtobufFormatSupport {
    ...
    void merge(infra.messaging.Message<?> message,
  ...
  static class ProtobufJavaUtilSupport implements ProtobufFormatSupport {
    ...
    @Override
    public void merge(infra.messaging.Message<?> message, Charset charset,
