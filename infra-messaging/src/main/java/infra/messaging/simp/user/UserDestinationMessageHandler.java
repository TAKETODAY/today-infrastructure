...
import infra.messaging.core.MessageSendingOperations;
...
import infra.messaging.simp.broker.OrderedMessageChannelDecorator;
...
public class UserDestinationMessageHandler implements MessageHandler, SmartLifecycle {
  ...
  private static final Logger logger = SimpLogging.forLogName(UserDestinationMessageHandler.class);
