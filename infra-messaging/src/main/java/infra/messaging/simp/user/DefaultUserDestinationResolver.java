...
import infra.messaging.simp.config.AbstractMessageBrokerConfiguration;
...
public class DefaultUserDestinationResolver implements UserDestinationResolver {
  ...
  private static final Logger logger = SimpLogging.forLogName(DefaultUserDestinationResolver.class);
   ...
   * {@link AbstractMessageBrokerConfiguration
