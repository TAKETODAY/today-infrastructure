...
import infra.messaging.simp.user.DestinationUserNameProvider;
...
public class SendToMethodReturnValueHandler implements HandlerMethodReturnValueHandler {
  ...
  private final PropertyPlaceholderHandler placeholderHelper = new PropertyPlaceholderHandler("{", "}", null, null, false);
