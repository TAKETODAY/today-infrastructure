...
import infra.messaging.converter.GsonMessageConverter;
import infra.messaging.converter.JacksonJsonMessageConverter;
import infra.messaging.converter.JsonbMessageConverter;
...
import infra.messaging.support.ImmutableMessageChannelInterceptor;
...
public abstract class AbstractMessageBrokerConfiguration implements ApplicationContextAware {
  ...
  /**
   * Return an {@link infra.validation.Validator} instance for
