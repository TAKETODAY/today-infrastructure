 ...
 * <li>{@link #setOrRemove(String, String)} set a header name to a single string value</li>
 * </ul>
 *
...
public class StompHeaders implements MultiValueMap<String, String>, Serializable {
  ...
  public void setContentType(@Nullable MimeType mimeType) {
    if (mimeType != null) {
      ...
      setOrRemove(CONTENT_TYPE, mimeType.toString());
    }
    else {
      setOrRemove(CONTENT_TYPE, (String) null);
    }
  }
  ...
  public @Nullable MimeType getContentType() {
    ...
    return StringUtils.isNotEmpty(value) ? MimeTypeUtils.parseMimeType(value) : null;
  }
  ...
  public void setDestination(@Nullable String destination) {
    setOrRemove(DESTINATION, destination);
  }
  ...
  public void setSubscription(@Nullable String subscription) {
    setOrRemove(SUBSCRIPTION, subscription);
  }
  ...
  public void setMessageId(@Nullable String messageId) {
    setOrRemove(MESSAGE_ID, messageId);
  }
  ...
  public void setReceiptId(@Nullable String receiptId) {
    setOrRemove(RECEIPT_ID, receiptId);
  }
   ...
   */
  @Override
  public @Nullable List<String> setOrRemove(String headerName, @Nullable String headerValue) {
    if (headerValue != null) {
  ...
  @Override
  public @Nullable List<String> setOrRemove(String headerName, String @Nullable [] headerValue) {
    if (headerValue != null) {
      List<String> headerValues = new ArrayList<>(headerValue.length);
      CollectionUtils.addAll(headerValues, headerValue);
      return headers.put(headerName, headerValues);
    }
    return headers.remove(headerName);
  }
  ...
  @Override
  public @Nullable List<String> setOrRemove(String headerName, @Nullable Collection<String> headerValue) {
    if (headerValue != null) {
      List<String> headerValues = new ArrayList<>(headerValue);
      return headers.put(headerName, headerValues);
    }
    return headers.remove(headerName);
  }
