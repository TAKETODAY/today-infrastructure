...
import infra.messaging.tcp.FixedIntervalReconnectStrategy;
import infra.messaging.tcp.TcpConnection;
import infra.messaging.tcp.TcpOperations;
import infra.messaging.tcp.reactor.ReactorNettyCodec;
...
public class StompBrokerRelayMessageHandler extends AbstractBrokerMessageHandler {
   ...
   * {@link StompBrokerRelayRegistration#setTaskScheduler(TaskScheduler)}.
   *
   ...
   *
   * @see #setTcpClient(TcpOperations)
   * @see infra.context.SmartLifecycle#isPausable()
   * @since 5.0
   */
  @Override
