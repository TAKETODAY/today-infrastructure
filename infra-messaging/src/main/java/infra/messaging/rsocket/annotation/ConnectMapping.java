...
package infra.messaging.rsocket.annotation;
 ...
 * {@link RSocketRequester RSocketRequester}
...
public @interface ConnectMapping {
   ...
   * {@link infra.util.RouteMatcher RouteMatcher}, the pattern may be
   * {@link infra.util.AntPathMatcher AntPathMatcher} or
   * {@link infra.web.util.pattern.PathPattern PathPattern} based.
