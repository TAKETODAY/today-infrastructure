...
import infra.messaging.handler.annotation.support.MethodArgumentNotValidException;
 ...
 * {@link infra.validation.annotation.Validated} or
...
public class PayloadMethodArgumentResolver implements HandlerMethodArgumentResolver {
   ...
   * {@link infra.validation.annotation.Validated}. Validation
  ...
  public final Mono<Object> resolveArgument(MethodParameter parameter, Message<?> message) {
    ...
    mimeType = mimeType != null ? mimeType : MimeType.APPLICATION_OCTET_STREAM;
