...
public abstract class AbstractMethodMessageHandler<T>
  ...
  private @Nullable Logger handlerMethodLogger;
  ...
  public void afterPropertiesSet() {
    ...
    Logger returnValueLogger = getReturnValueHandlerLogger();
   ...
   * @since 5.0
   */
  protected @Nullable Logger getReturnValueHandlerLogger() {
    return null;
  }
   ...
   * @since 5.0
   */
  protected @Nullable Logger getHandlerMethodLogger() {
    return null;
  }
