...
import static infra.messaging.rsocket.MetadataExtractor.ROUTE_KEY;
import static infra.util.MimeType.TEXT_HTML;
import static infra.util.MimeType.TEXT_PLAIN;
import static infra.util.MimeType.TEXT_XML;
