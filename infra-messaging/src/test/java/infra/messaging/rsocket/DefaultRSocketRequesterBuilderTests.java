...
class DefaultRSocketRequesterBuilderTests {
  ...
  void defaultDataMimeType() {
    ...
    assertThat(requester.dataMimeType())
            ...
            .isEqualTo(MimeType.TEXT_PLAIN);
  }

  @Test
  void defaultDataMimeTypeWithCustomDecoderRegistered() {
    RSocketStrategies strategies = RSocketStrategies.builder()
            .decoder(new TestJsonDecoder(MimeType.APPLICATION_JSON))
            .build();
    ...
    assertThat(requester.dataMimeType())
            ...
            .isEqualTo(MimeType.APPLICATION_JSON);
  }
  ...
  void dataMimeTypeExplicitlySet() {
    ...
    assertThat(requester.dataMimeType()).isEqualTo(MimeType.APPLICATION_JSON);
  }

  @Test
  void mimeTypesCannotBeChangedAtRSocketConnectorLevel() {
    MimeType dataMimeType = MimeType.APPLICATION_JSON;
  ...
  void setupRoute() {
    RSocketRequester requester = RSocketRequester.builder()
            .dataMimeType(MimeType.TEXT_PLAIN)
            .metadataMimeType(MimeType.TEXT_PLAIN)
            .setupRoute("toA")
            .setupData("My data")
            .transport(this.transport);
