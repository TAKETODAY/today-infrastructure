...
import infra.messaging.converter.ContentTypeResolver;
import infra.messaging.converter.DefaultContentTypeResolver;
import infra.messaging.converter.JacksonJsonMessageConverter;
...
import infra.messaging.simp.annotation.support.SimpAnnotationMethodMessageHandler;
...
import infra.messaging.simp.stomp.StompCommand;
import infra.messaging.simp.stomp.StompHeaderAccessor;
import infra.messaging.simp.user.DefaultUserDestinationResolver;
import infra.messaging.simp.user.MultiServerUserRegistry;
import infra.messaging.simp.user.SimpSubscription;
import infra.messaging.simp.user.SimpSubscriptionMatcher;
import infra.messaging.simp.user.SimpUser;
import infra.messaging.simp.user.SimpUserRegistry;
import infra.messaging.simp.user.UserDestinationMessageHandler;
import infra.messaging.simp.user.UserRegistryMessageHandler;
import infra.messaging.support.AbstractSubscribableChannel;
import infra.messaging.support.ChannelInterceptor;
import infra.messaging.support.ExecutorSubscribableChannel;
import infra.messaging.support.MessageBuilder;
import infra.messaging.tcp.ReconnectStrategy;
...
class MessageBrokerConfigurationTests {
  ...
  void configureMessageConvertersDefault() {
    ...
    assertThat(((DefaultContentTypeResolver) resolver).getDefaultMimeType()).isEqualTo(MimeType.APPLICATION_JSON);
  }
