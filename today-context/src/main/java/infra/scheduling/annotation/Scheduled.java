...
public @interface Scheduled {
   ...
   * @see CronTrigger#CronTrigger(String, java.util.TimeZone)
   ...
   * with {@link SimpleAsyncTaskScheduler}.
   *
   * @return the delay
   */
   ...
   *     <li>any of the known {@link infra.format.annotation.DurationFormat.Style
   *     DurationFormat.Style}: the {@link infra.format.annotation.DurationFormat.Style#ISO8601 ISO8601}
   *     style or the {@link infra.format.annotation.DurationFormat.Style#SIMPLE SIMPLE} style
   ...
   * or a {@link infra.format.annotation.DurationFormat.Style#ISO8601 java.time.Duration} compliant value
   * or a {@link infra.format.annotation.DurationFormat.Style#SIMPLE simple format} compliant value
   * @see #fixedDelay()
   */
