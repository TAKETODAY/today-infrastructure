...
public class BeanMethodQualificationTests {
  ...
  public void testBeanNamesForAnnotation() {
    ...
    assertThat(ctx.getBeanNamesForAnnotation(Configuration.class)).isEqualTo(Set.of("beanMethodQualificationTests.StandardConfig"));
    assertThat(ctx.getBeanNamesForAnnotation(Scope.class)).isEqualTo(Set.of());
