...
import static infra.format.annotation.DurationFormat.Style.COMPOSITE;
import static infra.format.annotation.DurationFormat.Style.ISO8601;
import static infra.format.annotation.DurationFormat.Style.SIMPLE;
import static infra.format.annotation.DurationFormat.Unit;
