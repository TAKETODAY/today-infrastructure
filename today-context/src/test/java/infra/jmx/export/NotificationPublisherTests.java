...
public class NotificationPublisherTests extends AbstractMBeanServerTests {
  ...
  public void testSimpleBean() throws Exception {
    ...
    ConfigurableApplicationContext ctx = loadContext("infra/jmx/export/notificationPublisherTests.xml");
  ...
  public void testMBean() throws Exception {
	...
	public void testStandardMBean() throws Exception {
		// start the MBeanExporter
		ApplicationContext ctx = new ClassPathXmlApplicationContext("infra/jmx/export/notificationPublisherTests.xml");
  ...
  public void testLazyInit() throws Exception {
    // start the MBeanExporter
    ConfigurableApplicationContext ctx = loadContext("infra/jmx/export/notificationPublisherLazyTests.xml");
