...
import infra.context.event.test.AbstractIdentifiable;
import infra.context.event.test.AnotherTestEvent;
import infra.context.event.test.EventCollector;
import infra.context.event.test.GenericEventPojo;
import infra.context.event.test.Identifiable;
...
class AnnotationDrivenEventListenerTests {
  ...
  void simpleEventXmlConfig() {
    this.context = new ClassPathXmlApplicationContext(
            "infra/context/event/simple-event-configuration.xml");
  ...
  private static class CustomScope implements infra.beans.factory.config.Scope {
