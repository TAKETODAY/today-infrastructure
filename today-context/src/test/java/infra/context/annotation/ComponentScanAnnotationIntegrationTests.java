...
import infra.context.annotation.ComponentScanParserTests.KustomAnnotationAutowiredBean;
import infra.context.annotation.componentscan.simple.ClassWithNestedComponents;
...
class ComponentScanAnnotationIntegrationTests {
  ...
  @ComposedConfiguration(basePackages = "infra.context.annotation.componentscan.simple")
...
@Configuration
@ComponentScan(
        basePackages = "infra.context.annotation",
