...
package infra.context.annotation.spr10546;
...
import infra.context.annotation.spr10546.scanpackage.AEnclosingConfig;
...
public class Spr10546Tests {
  ...
  /**
   * this might have succeeded depending on the ordering the
