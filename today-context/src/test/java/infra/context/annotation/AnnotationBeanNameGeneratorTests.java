...
class AnnotationBeanNameGeneratorTests {
  ...
  /**
   * @see infra.web.annotation.RestController
   */
  @Retention(RetentionPolicy.RUNTIME)
  @Target(ElementType.TYPE)
  @Controller
  ...
  /**
   * Mock of {@code infra.web.bind.annotation.ControllerAdvice},
  ...
  /**
   * Mock of {@code infra.web.bind.annotation.RestControllerAdvice},
   * which also has a {@code value} attribute that is NOT a {@code String} that
   * is meant to be used for the component name.
