...
package infra.aop.aspectj.generic;
...
public class GenericParameterMatchingTests {
  ...
  static class CounterAspect {
    ...
    @Pointcut("execution(* infra.aop.aspectj.generic.GenericParameterMatchingTests.GenericInterface.save(..))")
    public void genericInterfaceGenericArgExecution() { }

    @Pointcut("execution(* infra.aop.aspectj.generic.GenericParameterMatchingTests.GenericInterface.saveAll(..))")
