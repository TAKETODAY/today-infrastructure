...
import infra.aop.support.NameMatchMethodPointcut;
...
import infra.aop.testfixture.advice.CountingAfterReturningAdvice;
import infra.aop.testfixture.advice.CountingBeforeAdvice;
import infra.aop.testfixture.advice.MethodCounter;
...
import infra.aop.testfixture.interceptor.TimestampIntroductionInterceptor;
...
public abstract class AbstractAopProxyTests {
   ...
   * infra.cglib UndeclaredThrowableException
   */
  @Test
  ...
  static class MockTargetSource implements TargetSource {
    ...
    /**
     * @see infra.aop.TargetSource#getTarget()
     */
    @Override
    public Object getTarget() throws Exception {
      ++gets;
    ...
    /**
     * @see infra.aop.TargetSource#releaseTarget(java.lang.Object)
     */
    @Override
    ...
    /**
     * @see infra.aop.TargetSource#isStatic()
     */
    @Override
    public boolean isStatic() {
      return false;
