 ...
 * be any mix of {@link JSONObject JSONObjects}, {@link infra.context.properties.json.JSONArray JSONArrays}, Strings,
...
public class JSONObject {
   ...
   * @throws infra.context.properties.json.JSONException if the parse fails or doesn't yield a {@code JSONObject}.
   */
  public JSONObject(infra.context.properties.json.JSONTokener readFrom) throws infra.context.properties.json.JSONException {
    /*
    ...
    if (object instanceof JSONObject) {
      ...
      throw infra.context.properties.json.JSON.typeMismatch(object, "JSONObject");
    }
  }
   ...
   * @throws infra.context.properties.json.JSONException if the parse fails or doesn't yield a {@code
   * JSONObject}.
   */
  public JSONObject(String json) throws infra.context.properties.json.JSONException {
    this(new infra.context.properties.json.JSONTokener(json));
  }
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public JSONObject(JSONObject copyFrom, String[] names) throws infra.context.properties.json.JSONException {
    this();
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public JSONObject put(String name, boolean value) throws infra.context.properties.json.JSONException {
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public JSONObject put(String name, double value) throws infra.context.properties.json.JSONException {
    this.nameValuePairs.put(checkName(name), infra.context.properties.json.JSON.checkDouble(value));
    return this;
  }
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public JSONObject put(String name, int value) throws infra.context.properties.json.JSONException {
    this.nameValuePairs.put(checkName(name), value);
    return this;
  }
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public JSONObject put(String name, long value) throws infra.context.properties.json.JSONException {
    this.nameValuePairs.put(checkName(name), value);
    return this;
  }
   ...
   *
   * @param name the name of the property
   * @param value a {@link JSONObject}, {@link infra.context.properties.json.JSONArray}, String, Boolean, Integer,
   * Long, Double, {@link #NULL}, or {@code null}. May not be {@link Double#isNaN()
   * NaNs} or {@link Double#isInfinite() infinities}.
   * @return this object.
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public JSONObject put(String name, Object value) throws infra.context.properties.json.JSONException {
    if (value == null) {
    ...
    if (value instanceof Number) {
      ...
      // doubles
      infra.context.properties.json.JSON.checkDouble(((Number) value).doubleValue());
    }
    this.nameValuePairs.put(checkName(name), value);
    return this;
  }
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public JSONObject putOpt(String name, Object value) throws infra.context.properties.json.JSONException {
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public JSONObject accumulate(String name, Object value) throws infra.context.properties.json.JSONException {
    ...
    if (current instanceof infra.context.properties.json.JSONArray array) {
      array.put(value);
    }
    else {
      infra.context.properties.json.JSONArray array = new infra.context.properties.json.JSONArray();
      array.put(current);
      array.put(value);
  ...
  String checkName(String name) throws infra.context.properties.json.JSONException {
    if (name == null) {
      throw new infra.context.properties.json.JSONException("Names must be non-null");
    }
    return name;
  }
   ...
   * @param name the name of the property
   * @return the value
   * @throws infra.context.properties.json.JSONException if no such mapping exists.
   */
  public Object get(String name) throws infra.context.properties.json.JSONException {
    Object result = this.nameValuePairs.get(name);
    if (result == null) {
      throw new infra.context.properties.json.JSONException("No value for " + name);
    }
    return result;
  }
   ...
   * @param name the name of the property
   * @return the value
   * @throws infra.context.properties.json.JSONException if the mapping doesn't exist or cannot be coerced to a
   * boolean.
   */
  public boolean getBoolean(String name) throws infra.context.properties.json.JSONException {
    Object object = get(name);
    Boolean result = infra.context.properties.json.JSON.toBoolean(object);
    if (result == null) {
      throw infra.context.properties.json.JSON.typeMismatch(name, object, "boolean");
    }
    return result;
  }
   ...
   * double.
   */
  public double getDouble(String name) throws infra.context.properties.json.JSONException {
    Object object = get(name);
    Double result = infra.context.properties.json.JSON.toDouble(object);
    if (result == null) {
      throw infra.context.properties.json.JSON.typeMismatch(name, object, "double");
    }
    return result;
  }
   ...
   * @param name the name of the property
   * @return the value
   * @throws infra.context.properties.json.JSONException if the mapping doesn't exist or cannot be coerced to an int.
   */
  public int getInt(String name) throws infra.context.properties.json.JSONException {
    Object object = get(name);
    Integer result = infra.context.properties.json.JSON.toInteger(object);
    if (result == null) {
      throw infra.context.properties.json.JSON.typeMismatch(name, object, "int");
    }
    return result;
  }
   ...
   * @param name the name of the property
   * @return the value
   * @throws infra.context.properties.json.JSONException if the mapping doesn't exist or cannot be coerced to a long.
   */
  public long getLong(String name) throws infra.context.properties.json.JSONException {
    Object object = get(name);
    Long result = infra.context.properties.json.JSON.toLong(object);
    if (result == null) {
      throw infra.context.properties.json.JSON.typeMismatch(name, object, "long");
    }
    return result;
  }
   ...
   * @throws infra.context.properties.json.JSONException if no such mapping exists.
   */
  public String getString(String name) throws infra.context.properties.json.JSONException {
    Object object = get(name);
    String result = infra.context.properties.json.JSON.toString(object);
    if (result == null) {
      throw infra.context.properties.json.JSON.typeMismatch(name, object, "String");
    }
    return result;
  }
   ...
   * @param name the name of the property
   * @return the value
   * @throws infra.context.properties.json.JSONException if the mapping doesn't exist or is not a {@code
   * JSONArray}.
   */
  public infra.context.properties.json.JSONArray getJSONArray(String name) throws infra.context.properties.json.JSONException {
    Object object = get(name);
    if (object instanceof infra.context.properties.json.JSONArray) {
      return (infra.context.properties.json.JSONArray) object;
    }
    else {
      throw infra.context.properties.json.JSON.typeMismatch(name, object, "JSONArray");
    }
  }
   ...
   * @return the value or {@code null}
   */
  public infra.context.properties.json.JSONArray optJSONArray(String name) {
    Object object = opt(name);
    return object instanceof infra.context.properties.json.JSONArray ? (infra.context.properties.json.JSONArray) object : null;
  }
   ...
   * JSONObject}.
   */
  public JSONObject getJSONObject(String name) throws infra.context.properties.json.JSONException {
    Object object = get(name);
    if (object instanceof JSONObject) {
      return (JSONObject) object;
    }
    else {
      throw infra.context.properties.json.JSON.typeMismatch(name, object, "JSONObject");
    }
  }
   ...
   * @return the array
   */
  public infra.context.properties.json.JSONArray toJSONArray(infra.context.properties.json.JSONArray names) {
    infra.context.properties.json.JSONArray result = new infra.context.properties.json.JSONArray();
    if (names == null) {
      return null;
    }
    ...
    for (int i = 0; i < length; i++) {
      String name = infra.context.properties.json.JSON.toString(names.opt(i));
      result.put(opt(name));
    }
    return result;
  }
   ...
   * @return the array
   */
  public infra.context.properties.json.JSONArray names() {
    return this.nameValuePairs.isEmpty() ? null : new infra.context.properties.json.JSONArray(new ArrayList<>(this.nameValuePairs.keySet()));
  }
  ...
  public String toString() {
    try {
      infra.context.properties.json.JSONStringer stringer = new infra.context.properties.json.JSONStringer();
      writeTo(stringer);
      return stringer.toString();
    }
    catch (infra.context.properties.json.JSONException e) {
      return null;
    }
  }
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public String toString(int indentSpaces) throws infra.context.properties.json.JSONException {
    infra.context.properties.json.JSONStringer stringer = new infra.context.properties.json.JSONStringer(indentSpaces);
    writeTo(stringer);
    return stringer.toString();
  }

  void writeTo(infra.context.properties.json.JSONStringer stringer) throws infra.context.properties.json.JSONException {
    stringer.object();
   ...
   * @throws infra.context.properties.json.JSONException if an error occurs
   */
  public static String numberToString(Number number) throws infra.context.properties.json.JSONException {
    if (number == null) {
      throw new infra.context.properties.json.JSONException("Number must be non-null");
    }

    double doubleValue = number.doubleValue();
    infra.context.properties.json.JSON.checkDouble(doubleValue);
  ...
  public static String quote(String data) {
    ...
    try {
      infra.context.properties.json.JSONStringer stringer = new infra.context.properties.json.JSONStringer();
      stringer.open(infra.context.properties.json.JSONStringer.Scope.NULL, "");
      stringer.value(data);
      stringer.close(infra.context.properties.json.JSONStringer.Scope.NULL, infra.context.properties.json.JSONStringer.Scope.NULL, "");
      return stringer.toString();
    }
    catch (infra.context.properties.json.JSONException e) {
  ...
  public static Object wrap(Object o) {
    ...
    if (o instanceof infra.context.properties.json.JSONArray || o instanceof JSONObject) {
      return o;
    }
    if (o.equals(NULL)) {
      return o;
    ...
    try {
      if (o instanceof Collection) {
        return new infra.context.properties.json.JSONArray((Collection) o);
      }
      else if (o.getClass().isArray()) {
        return new infra.context.properties.json.JSONArray(o);
      }
      if (o instanceof Map) {
