...
public class ConfigurationMetadataAnnotationProcessor extends AbstractProcessor {
  ...
  static final String ADDITIONAL_METADATA_LOCATIONS_OPTION = "infra.context.properties.additionalMetadataLocations";

  static final String CONFIGURATION_PROPERTIES_ANNOTATION = "infra.context.properties.ConfigurationProperties";

  static final String CONFIGURATION_PROPERTIES_SOURCE_ANNOTATION = "infra.context.properties.ConfigurationPropertiesSource";

  static final String NESTED_CONFIGURATION_PROPERTY_ANNOTATION = "infra.context.properties.NestedConfigurationProperty";

  static final String DEPRECATED_CONFIGURATION_PROPERTY_ANNOTATION = "infra.context.properties.DeprecatedConfigurationProperty";

  static final String CONSTRUCTOR_BINDING_ANNOTATION = "infra.context.properties.bind.ConstructorBinding";

  static final String AUTOWIRED_ANNOTATION = "infra.beans.factory.annotation.Autowired";

  static final String DEFAULT_VALUE_ANNOTATION = "infra.context.properties.bind.DefaultValue";

  static final String NAME_ANNOTATION = "infra.context.properties.bind.Name";

  static final String AUTO_CONFIGURATION_ANNOTATION = "infra.context.annotation.config.AutoConfiguration";

  static final String DisableDIAUTO_CONFIGURATION_ANNOTATION = "infra.context.annotation.config.DisableDIAutoConfiguration";
  ...
  public synchronized void init(ProcessingEnvironment env) {
    ...
    this.metadataEnv = new MetadataGenerationEnvironment(env, configurationPropertiesAnnotation(),
            configurationPropertiesSourceAnnotation(), nestedConfigurationPropertyAnnotation(), deprecatedConfigurationPropertyAnnotation(),
      ...
      if (returns instanceof TypeElement typeElement) {
        ...
        if (this.metadataCollector.hasSimilarGroup(group)) {
          this.processingEnv.getMessager()
                  .printMessage(Kind.ERROR, "Duplicate @ConfigurationProperties definition for prefix '" + prefix + "'", element);
        }
        else {
