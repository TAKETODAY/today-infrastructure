...
import cn.taketoday.context.properties.sample.immutable.ImmutableCollectionProperties;
import cn.taketoday.context.properties.sample.immutable.ImmutableInnerClassProperties;
import cn.taketoday.context.properties.sample.immutable.ImmutablePrimitiveProperties;
import cn.taketoday.context.properties.sample.immutable.ImmutablePrimitiveWithDefaultsProperties;
import cn.taketoday.context.properties.sample.immutable.ImmutablePrimitiveWrapperWithDefaultsProperties;
  ...
  void constructorParameterMetadataNestedGroup() {
    process(ImmutableInnerClassProperties.class, (roundEnv, metadataEnv) -> {
      ...
      assertItemMetadata(metadataEnv, property).isGroup()
              .hasName("test.first")
              .hasType("cn.taketoday.context.properties.sample.immutable.ImmutableInnerClassProperties$Foo")
