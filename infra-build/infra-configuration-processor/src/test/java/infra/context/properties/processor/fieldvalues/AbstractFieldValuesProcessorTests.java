...
package infra.context.properties.processor.fieldvalues;
...
import infra.context.properties.sample.fieldvalues.FieldValues;
...
public abstract class AbstractFieldValuesProcessorTests {
  ...
  @SupportedAnnotationTypes({ "infra.context.properties.sample.TestConfigurationProperties" })
