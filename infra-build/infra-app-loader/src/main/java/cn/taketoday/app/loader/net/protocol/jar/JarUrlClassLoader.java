...
import cn.taketoday.app.loader.LaunchedClassLoader;
import cn.taketoday.app.loader.jar.NestedJarFile;
...
public abstract class JarUrlClassLoader extends URLClassLoader {
  ...
  public void clearCache() {
    Handler.clearCache();
    cn.taketoday.app.loader.net.protocol.nested.Handler.clearCache();
    try {
      clearJarFiles();
    }
    catch (IOException ex) {
