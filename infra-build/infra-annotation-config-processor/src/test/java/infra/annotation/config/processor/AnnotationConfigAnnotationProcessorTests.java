...
class AnnotationConfigAnnotationProcessorTests {
  ...
  void annotatedClass() {
    compile(TestClassConfiguration.class, (properties) -> {
      ...
      assertThat(properties)
              .containsKey("infra.annotation.config.processor.TestClassConfiguration$Nested");
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestClassConfiguration.ConditionalOnBean",
              "java.io.OutputStream");
      assertThat(properties).containsEntry("infra.annotation.config.processor."
  ...
  void annotatedClassWithOnlyAutoConfiguration() {
    compile(TestAutoConfigurationOnlyConfiguration.class, (properties) -> {
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestAutoConfigurationOnlyConfiguration", "");
      assertThat(properties).doesNotContainEntry(
              "infra.annotation.config.processor.TestAutoConfigurationOnlyConfiguration.AutoConfigureAfter",
              "");
      assertThat(properties).doesNotContainEntry(
              "infra.annotation.config.processor.TestAutoConfigurationOnlyConfiguration.AutoConfigureBefore",
              "");
    });
  }
  ...
  void annotatedClassWithOnBeanThatHasName() {
    compile(TestOnBeanWithNameClassConfiguration.class, (properties) -> {
      ...
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestOnBeanWithNameClassConfiguration.ConditionalOnBean",
              "");
    });
  }
  ...
  void annotatedClassWithOrder() {
    compile(TestOrderedClassConfiguration.class, (properties) -> {
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestOrderedClassConfiguration.ConditionalOnClass",
              "java.io.InputStream,java.io.OutputStream");
      assertThat(properties).containsEntry("infra.annotation.config.processor."
              + "TestOrderedClassConfiguration.AutoConfigureBefore", "test.before1,test.before2");
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestOrderedClassConfiguration.AutoConfigureAfter",
              "java.io.ObjectInputStream");
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestOrderedClassConfiguration.AutoConfigureOrder",
              "123");
    });
  ...
  void annotatedClassWithAutoConfiguration() {
    compile(TestAutoConfigurationConfiguration.class, (properties) -> {
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestAutoConfigurationConfiguration", "");
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestAutoConfigurationConfiguration.AutoConfigureBefore",
              "java.io.InputStream,test.before1,test.before2");
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestAutoConfigurationConfiguration.AutoConfigureAfter",
  ...
  void annotatedClassWithAutoConfigurationMerged() {
    compile(TestMergedAutoConfigurationConfiguration.class, (properties) -> {
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestMergedAutoConfigurationConfiguration", "");
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestMergedAutoConfigurationConfiguration.AutoConfigureBefore",
              "java.io.InputStream,test.before1,test.before2,java.io.ObjectInputStream,test.before3,test.before4");
      assertThat(properties).containsEntry(
              "infra.annotation.config.processor.TestMergedAutoConfigurationConfiguration.AutoConfigureAfter",
