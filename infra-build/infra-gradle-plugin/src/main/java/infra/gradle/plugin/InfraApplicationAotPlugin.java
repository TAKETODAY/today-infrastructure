...
import infra.gradle.tasks.aot.AbstractAot;
import infra.gradle.tasks.aot.ProcessAot;
import infra.gradle.tasks.aot.ProcessTestAot;
...
public class InfraApplicationAotPlugin implements Plugin<Project> {
  ...
  private void addJUnitPlatformLauncherDependency(Project project, Configuration configuration) {
    ...
    Dependency infraDependencies = dependencyHandler.create(dependencyHandler.platform(InfraApplicationPlugin.dependenciesCoordinates(project)));
