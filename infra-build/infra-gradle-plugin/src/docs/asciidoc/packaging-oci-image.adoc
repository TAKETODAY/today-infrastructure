...
Images can be built using the `infraBuildImage` task.
...
The task is automatically created when the `java` or `war` plugin is applied and is an instance of {infra-build-image-javadoc}[`InfraBuildImage`].



[[build-image.docker-daemon]]
== Docker Daemon
The `infraBuildImage` task requires access to a Docker daemon.
...
Environment variables can be set to configure the `infraBuildImage` task to use an alternative local or remote connection.
...
| `paketobuildpacks/builder-jammy-base:latest` or `paketobuildpacks/builder:tiny` when {nbt-gradle-plugin}[GraalVM Native Image plugin] is applied.
...
| `imageName`
| `--imageName`
| {infra-application-api}/buildpack/platform/docker/type/ImageReference.html#of-java.lang.String-[Image name] for the generated image.
| `docker.io/library/${project.name}:${project.version}`

| `pullPolicy`
| `--pullPolicy`
| {infra-application-api}/buildpack/platform/build/PullPolicy.html[Policy] used to determine when to pull the builder and run images from the registry.
...
.Groovy
----
include::../gradle/packaging/infra-build-image-builder.gradle[tags=builder]
----
...
[indent=0]
----
	$ gradle infraBuildImage --builder=mine/java-cnb-builder --runImage=mine/java-cnb-run
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-env.gradle[tags=env]
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-env-proxy.gradle[tags=env]
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-env-runtime.gradle[tags=env-runtime]
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-name.gradle[tags=image-name]
----
...
[indent=0]
----
	$ gradle infraBuildImage --imageName=example.com/library/my-app:v1
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-buildpacks.gradle[tags=buildpacks]
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-publish.gradle[tags=publish]
----
...
[indent=0]
----
	$ gradle infraBuildImage --imageName=docker.example.com/library/my-app:v1 --publishImage
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-caches.gradle[tags=caches]
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-docker-host.gradle[tags=docker-host]
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-docker-host-podman.gradle[tags=docker-host]
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-docker-auth-user.gradle[tags=docker-auth-user]
----
...
.Groovy
----
include::../gradle/packaging/infra-build-image-docker-auth-token.gradle[tags=docker-auth-token]
----
