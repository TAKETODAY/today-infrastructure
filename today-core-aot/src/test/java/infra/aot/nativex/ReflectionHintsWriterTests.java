...
public class ReflectionHintsWriterTests {
  ...
  void one() throws JSONException {
    ...
    assertEquals("""
            [
            	{
            		"name": "infra.core.codec.StringDecoder",
            		...
            		"queriedMethods":  [
            			{ "name": "<init>", "parameterTypes": [ "java.util.List", "boolean", "infra.util.MimeType" ] },
            ...
            [
            	{
            		...
            		"methods": [
            			{
            				"name": "test",
            				"parameterTypes": ["infra.aot.nativex.ReflectionHintsWriterTests$Inner"]
            			}
            		]
            	}
            ]
