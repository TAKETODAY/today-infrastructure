...
class DefaultMethodReferenceTests {
  ...
  private static final String EXPECTED_STATIC = "infra.aot.generate.DefaultMethodReferenceTests::someMethod";

  private static final String EXPECTED_ANONYMOUS_INSTANCE = "<instance>::someMethod";

  private static final String EXPECTED_DECLARED_INSTANCE = "<infra.aot.generate.DefaultMethodReferenceTests>::someMethod";
