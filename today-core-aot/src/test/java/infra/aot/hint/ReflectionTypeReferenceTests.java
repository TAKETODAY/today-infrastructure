...
class ReflectionTypeReferenceTests {
	...
	static Stream<Arguments> reflectionTargetNames() {
		return Stream.of(
				...
				arguments(StaticNested.class, "infra.aot.hint.ReflectionTypeReferenceTests$StaticNested"),
				arguments(StaticNested[].class, "infra.aot.hint.ReflectionTypeReferenceTests$StaticNested[]"),
				arguments(Inner.class, "infra.aot.hint.ReflectionTypeReferenceTests$Inner"),
				arguments(Inner[].class, "infra.aot.hint.ReflectionTypeReferenceTests$Inner[]")
		);
	}
