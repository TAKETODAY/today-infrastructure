...
package infra.app.jdbc.config.health;
...
import infra.app.jdbc.config.DataSourcePoolMetadataProvidersConfiguration;
import infra.app.jdbc.config.EmbeddedDataSourceConfiguration;
import infra.app.jdbc.config.health.DataSourceHealthContributorAutoConfiguration.RoutingDataSourceHealthContributor;
import infra.app.jdbc.health.DataSourceHealthIndicator;
...
class DataSourceHealthContributorAutoConfigurationTests {
  ...
  void runWithValidationQueryPropertyShouldUseCustomQuery() {
    this.contextRunner
            ...
            .withPropertyValues("datasource.test.connection-test-query:SELECT from FOOBAR")
            .run((context) -> {
              assertThat(context).hasSingleBean(DataSourceHealthIndicator.class);
  ...
  static class NonStandardDataSourceConfig {
    ...
    @ConfigurationProperties("datasource.non-default")
    ...
    @ConfigurationProperties("datasource.non-autowire")
  ...
  static class ProxyDataSourceBeanPostProcessor implements InitializationBeanPostProcessor {
