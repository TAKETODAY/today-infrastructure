...
abstract class Util {
  ...
  public static int extractFromClasspathToFile(String packagePath, File toDir) throws IOException {
    ...
    PatternResourceLoader resourcePatternResolver = new PathMatchingPatternResourceLoader();
    Resource[] resources = resourcePatternResolver.getResourcesArray(locationPattern);
