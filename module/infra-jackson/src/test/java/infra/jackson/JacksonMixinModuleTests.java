...
import infra.jackson.scan.b.RenameMixInAbstractClass;
import infra.jackson.scan.c.RenameMixInInterface;
import infra.jackson.scan.d.EmptyMixInClass;
import infra.jackson.scan.f.EmptyMixIn;
  ...
  void emptyMixInWithEmptyTypesShouldFail() {
    assertThatExceptionOfType(BeanCreationException.class).isThrownBy(() -> load(EmptyMixIn.class))
            ...
            .withStackTraceContaining("@JacksonMixin annotation on class "
                    + "'infra.jackson.scan.f.EmptyMixIn' does not specify any types");
  }
