 ...
 * {@link infra.core.io.PathMatchingPatternResourceLoader} to find migration files in a native image.
 *
...
class NativeImageResourceProvider implements ResourceProvider {
  ...
  public Collection<LoadableResource> getResources(String prefix, String[] suffixes) {
    ...
    Predicate<LocatedResource> matchesPrefixAndSuffixes = (locatedResource) -> StringUtils
            .startsAndEndsWith(locatedResource.resource.getName(), prefix, suffixes);
