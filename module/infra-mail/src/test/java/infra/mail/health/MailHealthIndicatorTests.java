...
/**
 * Tests for {@link infra.mail.health.MailHealthIndicator}.
 *
...
class MailHealthIndicatorTests {
  ...
  private infra.mail.health.MailHealthIndicator indicator;
  ...
  void setup() {
    ...
    this.indicator = new infra.mail.health.MailHealthIndicator(this.mailSender);
  }
