...
class GroovyTemplateAvailabilityProviderTests {
  ...
  void availabilityOfTemplateWithCustomLoaderPath() {
    this.environment.setProperty("groovy.template.resource-loader-path", "classpath:/custom-templates/");
  ...
  void availabilityOfTemplateWithCustomLoaderPathConfiguredAsAList() {
    this.environment.setProperty("groovy.template.resource-loader-path[0]", "classpath:/custom-templates/");
    assertThat(this.provider.isTemplateAvailable("custom", this.environment, getClass().getClassLoader(),
            this.resourceLoader))
            .isTrue();
  }
  ...
  void availabilityOfTemplateWithCustomPrefix() {
    this.environment.setProperty("groovy.template.prefix", "prefix/");
  ...
  void availabilityOfTemplateWithCustomSuffix() {
    this.environment.setProperty("groovy.template.suffix", ".groovytemplate");
