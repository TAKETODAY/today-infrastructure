...
import infra.app.test.context.AnnotationsPropertySourceTests.DeeplyNestedAnnotations.Level1;
import infra.app.test.context.AnnotationsPropertySourceTests.DeeplyNestedAnnotations.Level2;
import infra.app.test.context.AnnotationsPropertySourceTests.EnclosingClass.PropertyMappedAnnotationOnEnclosingClass;
import infra.app.test.context.AnnotationsPropertySourceTests.NestedAnnotations.Entry;
...
class AnnotationsPropertySourceTests {
  ...
  void createWhenSourceIsNullShouldThrowException() {
    assertThatIllegalArgumentException().isThrownBy(() -> new AnnotationsPropertySource(null))
            .withMessageContaining("Property source is required");
  }
