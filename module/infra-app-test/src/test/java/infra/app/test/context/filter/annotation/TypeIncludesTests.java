...
class TypeIncludesTests {
  ...
  private static final String IMPORTS_FILE = "META-INF/config/infra.app.test.context.filter.annotation.TypeIncludesTests$TestAnnotation.includes";

  @Test
  @WithResource(name = IMPORTS_FILE, content = """
          infra.app.test.context.filter.annotation.TypeIncludesTests
          infra.app.test.context.filter.annotation.DoesNotExist
          """)
