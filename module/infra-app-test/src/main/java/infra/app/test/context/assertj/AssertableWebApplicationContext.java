...
/**
 * A {@link ConfigurableApplicationContext} that additionally supports AssertJ style assertions.
...
public interface AssertableWebApplicationContext
   ...
   * {@link ConfigurableApplicationContext} or throw an exception if the context
   * fails to start.
   * @return a {@link AssertableWebApplicationContext} instance
   */
  static AssertableWebApplicationContext get(Supplier<? extends ConfigurableApplicationContext> contextSupplier) {
