...
/**
 * Annotation for a Infra rest client test that focuses <strong>only</strong> on beans
 * that use {@link RestTemplateBuilder} or {@link RestClient.Builder RestClient.Builder}.
 * <p>
