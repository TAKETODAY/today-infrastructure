 ...
 * @since 5.0
 */
public class InfraMockMvcBuilderCustomizer implements MockMvcBuilderCustomizer {
  ...
  /**
   * Create a new {@link InfraMockMvcBuilderCustomizer} instance.
   *
   * @param context the source application context
   */
  public InfraMockMvcBuilderCustomizer(ApplicationContext context) {
  ...
  static class DeferredLinesWriter implements LinesWriter {
    ...
    DeferredLinesWriter(ApplicationContext context, LinesWriter delegate) {
