...
import infra.testcontainers.service.connection.ContainerConnectionDetailsFactory;
import infra.testcontainers.service.connection.ContainerConnectionSource;
 ...
 * @author Phillip Webb
 */
class JdbcContainerConnectionDetailsFactory extends ContainerConnectionDetailsFactory<JdbcDatabaseContainer<?>, JdbcConnectionDetails> {

  @Override
  protected JdbcConnectionDetails getContainerConnectionDetails(ContainerConnectionSource<JdbcDatabaseContainer<?>> source) {
