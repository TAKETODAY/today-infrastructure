...
import infra.tests.sample.objects.DerivedTestObject;
import infra.tests.sample.objects.ITestInterface;
import infra.tests.sample.objects.ITestObject;
...
class ClassUtilsTests {
  ...
  void forName() throws ClassNotFoundException {
    ...
    assertForName("infra.util.ClassUtilsTests.INNER", INNER.class);
    try {
      ClassUtils.forName("infra.util.ClassUtilsTests.INNERs");//
    }
    catch (ClassNotFoundException ignored) {
    }
    ...
    assertThat(ClassUtils.forName(String[][].class.getName(), classLoader)).isEqualTo(String[][].class);
    assertThat(ClassUtils.forName(String[][][].class.getName(), classLoader)).isEqualTo(String[][][].class);
    assertThat(ClassUtils.forName("infra.tests.sample.objects.TestObject", classLoader)).isEqualTo(TestObject.class);
    assertThat(ClassUtils.forName("infra.tests.sample.objects.TestObject[]", classLoader)).isEqualTo(TestObject[].class);
  ...
  void forNameWithNestedType() throws ClassNotFoundException {
    assertThat(ClassUtils.forName("infra.util.ClassUtilsTests$NestedClass", classLoader)).isEqualTo(NestedClass.class);
    assertThat(ClassUtils.forName("infra.util.ClassUtilsTests.NestedClass", classLoader)).isEqualTo(NestedClass.class);
  ...
  void getFullyClassFileName() {
    ...
    assertThat(ClassUtils.getFullyClassFileName(getClass())).isEqualTo("infra/util/ClassUtilsTests.class");
  }
  ...
  void getQualifiedName() {
    ...
    assertThat(className).as("Class name did not match").isEqualTo("infra.util.ClassUtilsTests");
  }
