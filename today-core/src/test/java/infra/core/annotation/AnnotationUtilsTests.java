...
import static infra.core.annotation.AnnotationUtils.VALUE;
import static infra.core.annotation.AnnotationUtils.findAnnotation;
import static infra.core.annotation.AnnotationUtils.findAnnotationDeclaringClass;
import static infra.core.annotation.AnnotationUtils.findAnnotationDeclaringClassForTypes;
import static infra.core.annotation.AnnotationUtils.getAnnotation;
import static infra.core.annotation.AnnotationUtils.getAnnotationAttributes;
import static infra.core.annotation.AnnotationUtils.getDeclaredRepeatableAnnotations;
import static infra.core.annotation.AnnotationUtils.getDefaultValue;
import static infra.core.annotation.AnnotationUtils.getRepeatableAnnotations;
import static infra.core.annotation.AnnotationUtils.getValue;
import static infra.core.annotation.AnnotationUtils.isAnnotationDeclaredLocally;
import static infra.core.annotation.AnnotationUtils.isAnnotationInherited;
import static infra.core.annotation.AnnotationUtils.isAnnotationMetaPresent;
import static infra.core.annotation.AnnotationUtils.synthesizeAnnotation;
...
class AnnotationUtilsTests {
  ...
  void getRepeatableAnnotationsDeclaredOnClass() {
    ...
    final List<String> expectedValuesInfra = asList("A", "B", "C", "meta1");
    ...
    assertThat(values).isEqualTo(expectedValuesInfra);
  ...
  void getRepeatableAnnotationsDeclaredOnClassAndSuperclass() {
    ...
    final List<String> expectedValuesInfra = asList("X", "Y", "Z", "meta2");
  ...
  void synthesizeAnnotationFromMapWithAttributeOfIncorrectType() {
    ...
    assertThatIllegalStateException().isThrownBy(() ->
            ...
            .withMessageContaining("Attribute 'value' in annotation infra.core.testfixture.stereotype.Component " +
  ...
  /**
   * Mock of {@code infra.web.bind.annotation.RequestMapping}.
   */
  @Retention(RetentionPolicy.RUNTIME)
  ...
  /**
   * Mock of {@code infra.web.bind.annotation.GetMapping}, except
  ...
  /**
   * Mock of {@code infra.web.annotation.PostMapping}, except
  ...
  /**
   * Mock of {@code infra.test.context.ContextHierarchy}.
   */
  @Retention(RetentionPolicy.RUNTIME)
  @interface Hierarchy {
    ContextConfig[] value();
