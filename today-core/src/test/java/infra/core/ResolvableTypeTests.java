...
public class ResolvableTypeTests {
  ...
  void toStrings() throws Exception {
    ...
    assertThat(forField("stringIntegerMultiValueMap")).hasToString("infra.util.MultiValueMap<java.lang.String, java.lang.Integer>");
  ...
  void spr11219() throws Exception {
    ...
    assertThat(type.toString()).isEqualTo("java.util.Collection<infra.core.ResolvableTypeTests$IBase<?>>");
  }
