...
class SpelDocumentationTests extends AbstractExpressionTests {
  ...
  class Constructors {
    ...
    void constructors() {
      ...
      societyContext.setRootObject(new IEEE());
      Inventor einstein =
              parser.parseExpression("new infra.expression.spel.testresources.Inventor('Albert Einstein',new java.util.Date(), 'German')").getValue(Inventor.class);
      assertThat(einstein.getName()).isEqualTo("Albert Einstein");
      //create new inventor instance within add method of List
      parser.parseExpression("members.add(new infra.expression.spel.testresources.Inventor('Albert Einstein', 'German'))").getValue(societyContext);
    }
  }
