...
import infra.expression.spel.testresources.Fruit;
...
public class ConstructorInvocationTests extends AbstractExpressionTests {
  ...
  void constructorThrowingException() {
    ...
    Expression expr = parser.parseExpression("new infra.expression.spel.ConstructorInvocationTests$Tester(#bar).i");
