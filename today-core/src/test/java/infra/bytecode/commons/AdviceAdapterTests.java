...
import static infra.bytecode.commons.MethodNodeBuilder.buildClassWithMethod;
import static infra.bytecode.commons.MethodNodeBuilder.toText;
 ...
 */
public class AdviceAdapterTests extends AsmTest {
  ...
  public void testAllMethods_precompiledClass(
    ...
    ClassVisitor expectedClassVisitor =
            new LocalVariablesSorterTests.LocalVariablesSorterClassAdapter(
                    expectedClassWriter);
