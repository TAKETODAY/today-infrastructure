...
import cn.taketoday.core.annotation.AnnotationTypeMapping.MirrorSets;
import cn.taketoday.core.annotation.AnnotationTypeMapping.MirrorSets.MirrorSet;
import cn.taketoday.lang.UsesSunMisc;
...
class AnnotationTypeMappingsTests {
  ...
  void forAnnotationTypeWhenRepeatableMetaAnnotationIsFiltered() {
    AnnotationTypeMappings mappings = AnnotationTypeMappings.forAnnotationType(WithRepeatedMetaAnnotations.class,
            RepeatableContainers.standard(), Repeating.class.getName()::equals);
