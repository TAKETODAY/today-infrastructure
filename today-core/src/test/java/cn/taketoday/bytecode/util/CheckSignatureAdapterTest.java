...
public class CheckSignatureAdapterTest extends AsmTest {
  ...
  @ParameterizedTest
  @MethodSource({ "cn.taketoday.bytecode.util.SignaturesProviders#classSignatures" })
  ...
  @ParameterizedTest
  @MethodSource({ "cn.taketoday.bytecode.util.SignaturesProviders#methodSignatures" })
  ...
  @ParameterizedTest
  @MethodSource({ "cn.taketoday.bytecode.util.SignaturesProviders#fieldSignatures" })
