...
public class ReflectiveMethodExecutor implements MethodExecutor {
  ...
  public ReflectiveMethodExecutor(Method method, @Nullable Class<?> targetClass) {
    ...
    this.methodToInvoke = ReflectionUtils.getPubliclyAccessibleMethodIfPossible(method, targetClass);
   ...
   * <p>See {@link ReflectionUtils#getPubliclyAccessibleMethodIfPossible(Method, Class)} for
   * details.
   *
