 ...
 * {@link cn.taketoday.expression.Expression} with both an
 * {@code EvaluationContext} and a root object as arguments:
 * {@link cn.taketoday.expression.Expression#getValue(EvaluationContext, Object)}.
 *
...
public final class SimpleEvaluationContext implements EvaluationContext {
  ...
  public static final class Builder {
     ...
     *
     * @see cn.taketoday.expression.Expression#getValue(EvaluationContext)
     * @see cn.taketoday.expression.Expression#getValue(EvaluationContext, Object)
     */
