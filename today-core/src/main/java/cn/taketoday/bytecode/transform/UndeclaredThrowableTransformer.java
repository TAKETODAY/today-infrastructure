...
import static cn.taketoday.bytecode.commons.MethodSignature.CONSTRUCTOR_NAME;
import static cn.taketoday.bytecode.core.EmitUtils.CSTRUCT_THROWABLE;
...
final class UndeclaredThrowableTransformer extends ClassEmitter {
  ...
  public CodeEmitter beginMethod(int access, final MethodSignature sig, final Type... exceptions) {
    ...
    return new CodeEmitter(e) {
      private final boolean isConstructor = CONSTRUCTOR_NAME.equals(sig.getName());
      ...
      public void visitMethodInsn(int opcode, String owner, String name, String descriptor, boolean isInterface) {
        ...
        if (isConstructor && !callToSuperSeen && CONSTRUCTOR_NAME.equals(name)) {
