...
public class ASMifier extends Printer {
  ...
  public void visit(
    ...
    text.add("import infra.bytecode.AnnotationVisitor;\n");
    text.add("import infra.bytecode.Attribute;\n");
    text.add("import infra.bytecode.ClassReader;\n");
    text.add("import infra.bytecode.ClassWriter;\n");
    text.add("import infra.bytecode.ConstantDynamic;\n");
    text.add("import infra.bytecode.FieldVisitor;\n");
    text.add("import infra.bytecode.Handle;\n");
    text.add("import infra.bytecode.Label;\n");
    text.add("import infra.bytecode.MethodVisitor;\n");
    text.add("import infra.bytecode.Opcodes;\n");
    text.add("import infra.bytecode.RecordComponentVisitor;\n");
    text.add("import infra.bytecode.Type;\n");
    text.add("import infra.bytecode.TypePath;\n");
