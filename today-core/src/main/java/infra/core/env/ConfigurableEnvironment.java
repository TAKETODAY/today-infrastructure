 ...
 * infra.context.support.AbstractApplicationContext#refresh() refresh()}
...
public interface ConfigurableEnvironment extends Environment, ConfigurablePropertyResolver {
   ...
   * @see infra.context.annotation.Profile
   ...
   * @see infra.context.support.AbstractApplicationContext#setParent
   */
