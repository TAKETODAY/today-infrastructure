 ...
 * {@link infra.context.annotation.Profile @Profile} annotation for
 ...
 * infra.context.EnvironmentAware EnvironmentAware} or {@code @Inject} the
 ...
 * @see infra.context.EnvironmentAware
 * @see infra.context.ConfigurableApplicationContext#getEnvironment
 * @see infra.context.ConfigurableApplicationContext#setEnvironment
 * @see infra.context.support.AbstractApplicationContext#createEnvironment
 * @since 4.0
 */
