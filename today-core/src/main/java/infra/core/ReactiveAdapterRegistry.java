  ...
  public static class CoreBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
      ...
      builder.allowBlockingCallsInside(
              "infra.core.LocalVariableTableParameterNameDiscoverer", "inspectClass");

      String className = "infra.util.ConcurrentReferenceHashMap$Segment";
      ...
      String referenceManagerClassName = "infra.util.ConcurrentReferenceHashMap$ReferenceManager";
