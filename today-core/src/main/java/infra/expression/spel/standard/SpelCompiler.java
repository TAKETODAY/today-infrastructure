...
public final class SpelCompiler extends BytecodeCompiler implements Opcodes {
  ...
  private Class<? extends CompiledExpression> createExpressionClass(SpelNodeImpl expressionToCompile) {
    // Create class outline 'spel/ExNNN extends infra.expression.spel.CompiledExpression'
    ...
    cw.visit(JAVA_VERSION, ACC_PUBLIC, className, null, "infra/expression/spel/CompiledExpression", null);

    // Create default constructor
    MethodVisitor mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
    mv.visitCode();
    mv.visitVarInsn(ALOAD, 0);
    mv.visitMethodInsn(INVOKESPECIAL, "infra/expression/spel/CompiledExpression",
            "<init>", "()V", false);
    mv.visitInsn(RETURN);
    mv.visitMaxs(1, 1);
    mv.visitEnd();
    ...
    mv = cw.visitMethod(ACC_PUBLIC, "getValue",
            "(Ljava/lang/Object;Linfra/expression/EvaluationContext;)Ljava/lang/Object;", null,
            new String[] { "infra/expression/EvaluationException" });
    mv.visitCode();
