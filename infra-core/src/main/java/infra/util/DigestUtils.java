...
public abstract class DigestUtils {
  ...
  private static byte[] digest(String algorithm, InputStream inputStream) throws IOException {
    ...
    if (inputStream instanceof FastByteArrayOutputStream.UpdateMessageDigestInputStream) {
      ((FastByteArrayOutputStream.UpdateMessageDigestInputStream) inputStream).updateMessageDigest(messageDigest);
    }
    else {
