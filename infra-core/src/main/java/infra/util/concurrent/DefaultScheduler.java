...
final class DefaultScheduler implements Scheduler {
  ...
  /**
   * The system property key used to configure the number of threads for the
   * scheduled thread pool in the {@link DefaultScheduler} class.
   *
   * <p>This property allows customization of the number of threads that
   * can be used by the scheduled thread pool. If this property is not set, the
   * default value of {@code 1} will be used.
   *
   * <p><b>Usage Example:</b>
   *
   ...
   * }</pre>
   *
   * <p>In this example, the scheduled thread pool will be configured with
   * 5 threads.
   */
  static final String PoolSize = "infra.util.concurrent.Scheduler.poolSize";
