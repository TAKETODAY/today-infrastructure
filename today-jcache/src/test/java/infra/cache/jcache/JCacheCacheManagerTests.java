...
import infra.cache.jcache.transaction.AbstractTransactionSupportingCacheManagerTests;
...
public class JCacheCacheManagerTests extends AbstractTransactionSupportingCacheManagerTests<JCacheCacheManager> {
  ...
  public void setupOnce() {
    ...
    cacheManagerMock.addCache(AbstractTransactionSupportingCacheManagerTests.CACHE_NAME);
  ...
  @Override
  protected Class<? extends infra.cache.Cache> getCacheType() {
