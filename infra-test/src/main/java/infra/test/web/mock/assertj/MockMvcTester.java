 ...
 *
 * <p>A tester instance can be created from a {@link ApplicationContext}:
 * <pre><code class="java">
...
public final class MockMvcTester {
   ...
   * <em>refreshed</em>) {@link ApplicationContext}. The given
   ...
   */
  public static MockMvcTester from(ApplicationContext applicationContext,
   ...
   * <em>refreshed</em>) {@link ApplicationContext}.
   * <p>Consider using {@link #from(ApplicationContext, Function)} if
