...
public interface RestTestClient {
   ...
   */
  static WebAppContextSetupBuilder bindToApplicationContext(ApplicationContext context) {
  ...
  interface Builder<B extends Builder<B>> {
     ...
     * @return this builder
     */
    <T extends B> T baseURI(String uri);

    /**
     * Provide a pre-configured {@link UriBuilderFactory} instance as an
     * alternative to and effectively overriding {@link #baseURI(String)}.
     *
     * @return this builder
     */
     ...
     * {@linkplain HttpHeaders#remove remove} values, or use any of the other
  ...
  /**
   * Extension of {@link Builder} for tests against а
   * {@linkplain MockMvcBuilders#webAppContextSetup(ApplicationContext) WebAppContext MockMvc setup}.
   */
  ...
  interface RequestHeadersSpec<S extends RequestHeadersSpec<S>> {
     ...
     * {@link infra.test.web.mock.client.assertj.RestTestClientResponse#from(ResponseSpec)}
  ...
  interface BodyContentSpec {
     ...
     * @see infra.test.util.XmlExpectationsHelper#assertXmlEqual(String, String)
     */
