...
import infra.test.validation.AbstractBindingResultAssert;
import infra.validation.BindingResult;
import infra.validation.BindingResultUtils;
...
public class ModelAssert extends AbstractMapAssert<ModelAssert, Map<String, Object>, String, Object> {
  ...
  private @Nullable BindingResult getBindingResult(String name) {
