...
public abstract class ContextCacheUtils {
   ...
   * <p>Uses {@link InfraStrategies} to retrieve a system property or Infra
  ...
  public static PauseMode retrievePauseMode() {
    String value = InfraStrategies.getProperty(ContextCache.CONTEXT_CACHE_PAUSE_PROPERTY_NAME);
  ...
  private static int retrieveProperty(String key, int defaultValue) {
    try {
      String value = InfraStrategies.getProperty(key);
      if (StringUtils.hasText(value)) {
