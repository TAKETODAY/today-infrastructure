 ...
 *
 * <ul>
 * <li>If the {@link #methodName methodName} is specified, Infra looks for a static
 * method with that name.</li>
 * <li>If a method name is not specified, Infra looks for exactly one static method
