...
public class MockitoResetTestExecutionListener extends AbstractTestExecutionListener {
  ...
  private static final Logger logger = LoggerFactory.getLogger(MockitoResetTestExecutionListener.class);
  ...
  private static @Nullable Object getBean(ConfigurableBeanFactory beanFactory, String beanName) {
    try {
