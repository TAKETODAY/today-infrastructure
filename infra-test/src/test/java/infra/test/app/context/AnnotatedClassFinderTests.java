...
package infra.test.app.context;

import org.junit.jupiter.api.Test;

import infra.app.InfraConfiguration;
import infra.test.app.context.example.ExampleConfig;
import infra.test.app.context.example.scan.Example;
...
class AnnotatedClassFinderTests {
  ...
  void findFromPackageWhenConfigurationIsFoundShouldReturnConfiguration() {
    Class<?> config = this.finder.findFromPackage("infra.test.app.context.example.scan");
    assertThat(config).isEqualTo(ExampleConfig.class);
  }
