...
package infra.test.app.config.override;

import org.junit.jupiter.api.Test;
import org.junit.jupiter.api.extension.ExtendWith;

import infra.test.app.config.ExampleTestConfig;
import infra.test.app.context.InfraTestContextBootstrapper;
...
class OverrideAutoConfigurationEnabledTrueIntegrationTests {
  ...
  void autoConfiguredContext() {
    ...
    assertThat(context.getBean(OverrideAutoConfigurationInfraApplication.class)).isNotNull();
