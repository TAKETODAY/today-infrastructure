...
class ExplicitPropertiesFileTestPropertySourceTests {
  ...
  class ClasspathTests {
    ...
    @TestPropertySource("/infra/test/context/env/explicit.properties")
    ...
    @TestPropertySource("/org/../infra/test/../test/context/env/explicit.properties")
  ...
  class FileSystemTests {
    ...
    @TestPropertySource("file:src/test/resources/infra/test/context/env/explicit.properties")
    ...
    @Nested
    @DisplayName("with relative path")
    @TestPropertySource("file:../infra-test/src/test/resources/infra/test/context/env/explicit.properties")
    class RelativePathTests extends AbstractExplicitPropertiesFileTests {
    }
    ...
    @TestPropertySource("file:${user.dir}/src/test/resources/infra/test/context/env/explicit.properties")
    ...
    @TestPropertySource("file:${user.dir}/../infra-test/src/test/resources/${current.test.package}/../env/explicit.properties")
