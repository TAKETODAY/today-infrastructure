...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoBeanByNameInParentContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = MockitoBeanByNameInParentContextHierarchyTests.Config2.class)
})
