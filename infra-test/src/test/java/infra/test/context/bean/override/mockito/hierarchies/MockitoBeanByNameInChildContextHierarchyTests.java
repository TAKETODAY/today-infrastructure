...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoBeanByNameInChildContextHierarchyTests.Config1.class),
        @ContextConfiguration(classes = MockitoBeanByNameInChildContextHierarchyTests.Config2.class, name = "child")
})
