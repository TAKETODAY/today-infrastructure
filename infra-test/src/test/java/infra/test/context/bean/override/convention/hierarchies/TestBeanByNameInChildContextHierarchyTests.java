...
@ContextHierarchy({
        @ContextConfiguration(classes = TestBeanByNameInChildContextHierarchyTests.Config1.class),
        @ContextConfiguration(classes = TestBeanByNameInChildContextHierarchyTests.Config2.class, name = "child")
})
