...
package infra.test.context.bean.override.convention.hierarchies;
...
@ContextHierarchy({
        @ContextConfiguration(classes = TestBeanByTypeInParentAndChildContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = TestBeanByTypeInParentAndChildContextHierarchyTests.Config2.class, name = "child")
})
