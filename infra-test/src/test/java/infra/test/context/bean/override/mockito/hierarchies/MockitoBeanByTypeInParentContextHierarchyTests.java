...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoBeanByTypeInParentContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = MockitoBeanByTypeInParentContextHierarchyTests.Config2.class)
})
