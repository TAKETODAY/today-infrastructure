...
@ContextHierarchy({
        @ContextConfiguration(classes = TestBeanByNameInParentAndChildContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = TestBeanByNameInParentAndChildContextHierarchyTests.Config2.class, name = "child")
})
