...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoSpyBeansByTypeInParentAndChildContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = MockitoSpyBeansByTypeInParentAndChildContextHierarchyTests.Config2.class, name = "child")
})
