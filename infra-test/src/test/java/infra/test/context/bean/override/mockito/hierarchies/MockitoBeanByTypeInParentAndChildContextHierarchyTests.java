...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoBeanByTypeInParentAndChildContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = MockitoBeanByTypeInParentAndChildContextHierarchyTests.Config2.class, name = "child")
})
