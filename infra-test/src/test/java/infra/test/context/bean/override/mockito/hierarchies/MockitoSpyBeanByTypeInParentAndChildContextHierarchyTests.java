...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoSpyBeanByTypeInParentAndChildContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = MockitoSpyBeanByTypeInParentAndChildContextHierarchyTests.Config2.class, name = "child")
})
