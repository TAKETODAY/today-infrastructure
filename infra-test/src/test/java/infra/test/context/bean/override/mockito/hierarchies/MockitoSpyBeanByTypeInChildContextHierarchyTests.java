...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoSpyBeanByTypeInChildContextHierarchyTests.Config1.class),
        @ContextConfiguration(classes = MockitoSpyBeanByTypeInChildContextHierarchyTests.Config2.class, name = "child")
})
