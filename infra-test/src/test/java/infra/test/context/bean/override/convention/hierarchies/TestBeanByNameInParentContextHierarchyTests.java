...
@ContextHierarchy({
        @ContextConfiguration(classes = TestBeanByNameInParentContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = TestBeanByNameInParentContextHierarchyTests.Config2.class)
})
