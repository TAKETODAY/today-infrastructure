...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoSpyBeanByTypeInParentContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = MockitoSpyBeanByTypeInParentContextHierarchyTests.Config2.class)
})
