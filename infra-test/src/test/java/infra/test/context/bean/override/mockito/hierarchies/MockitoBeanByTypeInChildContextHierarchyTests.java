...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoBeanByTypeInChildContextHierarchyTests.Config1.class),
        @ContextConfiguration(classes = MockitoBeanByTypeInChildContextHierarchyTests.Config2.class, name = "child")
})
