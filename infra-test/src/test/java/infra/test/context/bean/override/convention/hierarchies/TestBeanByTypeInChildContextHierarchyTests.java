...
@ContextHierarchy({
        @ContextConfiguration(classes = TestBeanByTypeInChildContextHierarchyTests.Config1.class),
        @ContextConfiguration(classes = TestBeanByTypeInChildContextHierarchyTests.Config2.class, name = "child")
})
