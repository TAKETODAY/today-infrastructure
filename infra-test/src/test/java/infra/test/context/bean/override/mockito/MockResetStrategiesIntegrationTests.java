 ...
 * @since 5.0
 */
// The MockVerificationExtension MUST be registered before the InfraExtension.
@ExtendWith(MockResetStrategiesIntegrationTests.MockVerificationExtension.class)
