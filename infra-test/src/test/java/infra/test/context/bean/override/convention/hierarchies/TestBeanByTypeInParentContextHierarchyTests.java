...
@ContextHierarchy({
        @ContextConfiguration(classes = TestBeanByTypeInParentContextHierarchyTests.Config1.class, name = "parent"),
        @ContextConfiguration(classes = TestBeanByTypeInParentContextHierarchyTests.Config2.class)
})
