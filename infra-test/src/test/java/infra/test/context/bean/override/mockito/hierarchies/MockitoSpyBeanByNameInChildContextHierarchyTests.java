...
@ContextHierarchy({
        @ContextConfiguration(classes = MockitoSpyBeanByNameInChildContextHierarchyTests.Config1.class),
        @ContextConfiguration(classes = MockitoSpyBeanByNameInChildContextHierarchyTests.Config2.class, name = "child")
})
