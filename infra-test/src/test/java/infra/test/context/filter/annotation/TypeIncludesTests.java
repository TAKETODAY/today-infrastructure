...
package infra.test.context.filter.annotation;
...
class TypeIncludesTests {
  ...
  private static final String IMPORTS_FILE = "META-INF/config/infra.test.context.filter.annotation.TypeIncludesTests$TestAnnotation.includes";

  @Test
  @WithResource(name = IMPORTS_FILE, content = """
          infra.test.context.filter.annotation.TypeIncludesTests
          infra.test.context.filter.annotation.DoesNotExist
          """)
