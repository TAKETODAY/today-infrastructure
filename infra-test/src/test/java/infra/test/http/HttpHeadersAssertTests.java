...
class HttpHeadersAssertTests {
  ...
  @Test
  void isEmpty() {
    assertThat(HttpHeaders.forWritable()).isEmpty();
  }
  ...
  void isNotEmptyWithNoHeaders() {
    assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> assertThat(HttpHeaders.forWritable()).isNotEmpty())
  ...
  void hasSameSizeAs() {
    ...
    HttpHeaders other = HttpHeaders.forWritable();
  ...
  private static HttpHeadersAssert assertThat(Map<String, String> values) {
    ...
    return assertThat(HttpHeaders.forWritable(map));
  }
