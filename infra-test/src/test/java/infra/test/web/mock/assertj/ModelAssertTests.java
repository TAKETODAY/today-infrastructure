...
/**
 * Tests for {@link infra.test.web.mock.assertj.ModelAssert}.
 *
...
class ModelAssertTests {
  ...
  void hasErrorsWithNoError() {
    AssertProvider<infra.test.web.mock.assertj.ModelAssert> actual = forModel(new TestBean(), Map.of("name", "John", "age", "42"));
  ...
  void doesNotHaveErrorsWithError() {
    AssertProvider<infra.test.web.mock.assertj.ModelAssert> actual = forModel(new TestBean(), Map.of("name", "John", "age", "4x"));
    assertThatExceptionOfType(AssertionError.class)
  ...
  void hasErrorCountForUnknownAttribute() {
    ...
    AssertProvider<infra.test.web.mock.assertj.ModelAssert> actual = forModel(model);
    assertThatExceptionOfType(AssertionError.class)
  ...
  private AssertProvider<infra.test.web.mock.assertj.ModelAssert> forModel(Map<String, Object> model) {
    return () -> new infra.test.web.mock.assertj.ModelAssert(model);
  }

  private AssertProvider<infra.test.web.mock.assertj.ModelAssert> forModel(Object instance, Map<String, Object> propertyValues) {
    Map<String, Object> model = new HashMap<>();
  ...
  private static void augmentModel(Map<String, Object> model, String attribute, Object instance, Map<String, Object> propertyValues) {
    ...
    PropertyValues pvs = new PropertyValues(propertyValues);
    binder.bind(pvs);
    try {
      binder.close();
