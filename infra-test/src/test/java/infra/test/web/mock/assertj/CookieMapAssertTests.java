...
/**
 * Tests for {@link infra.test.web.mock.assertj.CookieMapAssert}.
 *
 * @author Brian Clozel
 */
class CookieMapAssertTests {
  ...
  private static AssertProvider<infra.test.web.mock.assertj.CookieMapAssert> cookies() {
    return () -> new infra.test.web.mock.assertj.CookieMapAssert(cookies);
  }
