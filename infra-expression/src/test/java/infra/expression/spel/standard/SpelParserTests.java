...
import static infra.expression.spel.SpelMessage.NON_TERMINATING_DOUBLE_QUOTED_STRING;
import static infra.expression.spel.SpelMessage.NON_TERMINATING_QUOTED_STRING;
import static infra.expression.spel.SpelMessage.NOT_AN_INTEGER;
import static infra.expression.spel.SpelMessage.NOT_A_LONG;
import static infra.expression.spel.SpelMessage.OOD;
import static infra.expression.spel.SpelMessage.REAL_CANNOT_BE_LONG;
import static infra.expression.spel.SpelMessage.RIGHT_OPERAND_PROBLEM;
import static infra.expression.spel.SpelMessage.RUN_OUT_OF_ARGUMENTS;
import static infra.expression.spel.SpelMessage.UNEXPECTED_DATA_AFTER_DOT;
import static infra.expression.spel.SpelMessage.UNEXPECTED_ESCAPE_CHAR;
