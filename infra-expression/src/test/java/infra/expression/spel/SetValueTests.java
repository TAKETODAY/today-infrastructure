...
import static infra.expression.spel.SpelMessage.ARRAY_INDEX_OUT_OF_BOUNDS;
import static infra.expression.spel.SpelMessage.COLLECTION_INDEX_OUT_OF_BOUNDS;
import static infra.expression.spel.SpelMessage.INDEXING_NOT_SUPPORTED_FOR_TYPE;
import static infra.expression.spel.SpelMessage.SETVALUE_NOT_SUPPORTED;
import static infra.expression.spel.SpelMessage.TYPE_CONVERSION_ERROR;
...
public class SetValueTests extends AbstractExpressionTests {
   ...
   *
   * @see #evaluateAndCheckError(ExpressionParser, String, Class, SpelMessage, Object...)
   */
  ...
  private static ThrowableTypeAssert<infra.expression.spel.SpelEvaluationException> assertThatSpelEvaluationException() {
