...
import static infra.expression.spel.support.ReflectionHelper.ArgumentsMatchKind.REQUIRES_CONVERSION;
...
//		===> Expression '3+4+5+6+7-2' - AST end
  ...
  void reflectivePropertyAccessor() throws Exception {
    infra.expression.spel.support.ReflectivePropertyAccessor rpa = new ReflectivePropertyAccessor();
    Tester t = new Tester();
    t.setProperty("hello");
