...
import infra.cache.jcache.interceptor.JCacheAspectSupport;
 ...
 * @since 4.0
 */
@RequiredTypes({ "infra.cache.jcache.interceptor.JCacheAspectSupport", "javax.cache.annotation.CacheResult" })
