...
import static cn.taketoday.core.annotation.AnnotatedElementUtils.getAllAnnotationAttributes;
import static cn.taketoday.core.annotation.AnnotatedElementUtils.getAllMergedAnnotations;
import static cn.taketoday.core.annotation.AnnotatedElementUtils.getMergedAnnotation;
import static cn.taketoday.core.annotation.AnnotatedElementUtils.getMergedAnnotationAttributes;
import static cn.taketoday.core.annotation.AnnotatedElementUtils.getMetaAnnotationTypes;
import static cn.taketoday.core.annotation.AnnotatedElementUtils.hasAnnotation;
import static cn.taketoday.core.annotation.AnnotatedElementUtils.hasMetaAnnotationTypes;
import static cn.taketoday.core.annotation.AnnotatedElementUtils.isAnnotated;
import static cn.taketoday.core.annotation.AnnotationUtilsTests.asArray;
...
class AnnotatedElementUtilsTests {
	 ...
	 * logic in {@code cn.taketoday.context.annotation.ProfileCondition}
	 * to fail.
	 */
	@Test
	void getAllAnnotationAttributesOnClassWithLocalAnnotationThatShadowsAnnotationFromSuperclass() {
		// See cn.taketoday.core.env.EnvironmentSystemIntegrationTests#mostSpecificDerivedClassDrivesEnvironment_withDevEnvAndDerivedDevConfigClass
	...
	/**
	 * Note: this functionality is required by {@code cn.taketoday.context.annotation.ProfileCondition}.
	 */
	@Test
	...
	/**
	 * Mock of {@code cn.taketoday.test.context.TestPropertySource}.
	 */
	@Retention(RetentionPolicy.RUNTIME)
	...
	/**
	 * Mock of {@code cn.taketoday.boot.test.SpringApplicationConfiguration}.
	 */
	@ContextConfig
	@Retention(RetentionPolicy.RUNTIME)
