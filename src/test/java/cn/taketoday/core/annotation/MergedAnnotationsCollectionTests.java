...
class MergedAnnotationsCollectionTests {
  ...
  @Test
  void empty() {
    assertThat(MergedAnnotationsCollection.valueOf(null)).isEqualTo(TypeMappedAnnotations.NONE);
  }

  @Test
  void ofWhenEmptyReturnsSharedNoneInstance() {
    MergedAnnotations annotations = MergedAnnotationsCollection.valueOf(new ArrayList<>());
  ...
  void createWhenAnnotationIsNotDirectlyPresentThrowsException() {
    ...
    assertThatIllegalArgumentException().isThrownBy(() ->
                    MergedAnnotationsCollection.valueOf(Collections.singleton(annotation)))
  ...
  void getMetaWhenRootHasAttributeValuesShouldAliasAttributes() {
    ...
    MergedAnnotations annotations = MergedAnnotationsCollection.valueOf(
  ...
  private MergedAnnotations getDirectAndSimple() {
    ...
    return MergedAnnotationsCollection.valueOf(list);
  }
