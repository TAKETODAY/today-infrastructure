...
public class UtilNamespaceHandlerTests {
	...
	public void testEvents() {
		...
		BeanDefinition propertiesBean = (BeanDefinition) propertiesComponent.getBeanDefinitions()[0];
		...
		BeanDefinition constantBean = (BeanDefinition) constantComponent.getBeanDefinitions()[0];
