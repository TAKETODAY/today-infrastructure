...
public class TestFastClass extends cn.taketoday.context.cglib.CodeGenTestCase {
    ...
    public void testComplex() throws Throwable {
        ...
        assertEquals("fc.getName()", "cn.taketoday.context.cglib.reflect.MemberSwitchBean", fc.getName());
        ...
        assertEquals("fc1.toString()", "public cn.taketoday.context.cglib.reflect.MemberSwitchBean()", fc1.toString());
