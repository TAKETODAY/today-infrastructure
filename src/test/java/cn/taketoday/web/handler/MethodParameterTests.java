...
public class MethodParameterTests {
  ...
  public void test() throws NoSuchMethodException {
    final Method method = MethodParameterTests.class.getDeclaredMethod("method", String.class);
    final MethodParameter methodParameter = new MethodParameter(0, method, "name");
  ...
  public void testRequired() throws NoSuchMethodException {
    final Method method = MethodParameterTests.class.getDeclaredMethod("isRequired", String.class, int.class);
    final MethodParameter methodParameter = new MethodParameter(0, method, "name");
    ...
    final MethodParameter ageMethodParameter = new MethodParameter(1, method, null);
  ...
  public void getGenerics() throws NoSuchMethodException {
    final Method getGenerics = MethodParameterTests.class.getDeclaredMethod("getGenerics", List.class, Map.class, String.class);
    final MethodParameter listParameter = new MethodParameter(0, getGenerics, "names");
    final MethodParameter mapParameter = new MethodParameter(1, getGenerics, "map");
    final MethodParameter stringParameter = new MethodParameter(2, getGenerics, "name");
