...
public class JacksonMessageBodyConverterTests {
  ...
  static {
    try {
      final Method test = JacksonMessageBodyConverterTests.class.getDeclaredMethod("test", User.class);
      final Method testJsonNodeMethod = JacksonMessageBodyConverterTests.class.getDeclaredMethod("test", JsonNode.class);
      final Method testList = JacksonMessageBodyConverterTests.class
  ...
  public void testWrite() throws IOException {
    ...
    final JacksonMessageBodyConverter converter = new JacksonMessageBodyConverter();
