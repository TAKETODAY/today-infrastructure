...
import cn.taketoday.aop.CountingAfterReturningAdvice;
import cn.taketoday.aop.DynamicIntroductionAdvice;
import cn.taketoday.aop.MethodBeforeAdvice;
import cn.taketoday.aop.MyThrowsHandler;
...
import cn.taketoday.aop.mixin.Lockable;
...
import cn.taketoday.aop.support.NameMatchMethodPointcutTests.Person;
...
public abstract class AbstractAopProxyTests {
  ...
  public void testSerializableTargetAndAdvice() throws Throwable {
    ...
    assertThat(p2)
            .as("Proxies should be equal, even after one was serialized")
            .isEqualTo(p);
    assertThat(p)
            .as("Proxies should be equal, even after one was serialized")
            .isEqualTo(p2);
   ...
   */
  @Test
  public void testTargetReturnsThis() {
    // Test return value
  ...
  public void testCannotAddIntroductionAdviceToIntroduceClass() throws Throwable {
    ...
    assertThatIllegalArgumentException()
            ...
            .isThrownBy(() -> pc.addAdvisor(0, new DefaultIntroductionAdvisor(new TimestampIntroductionInterceptor(), TestBean.class)))
  ...
  public void testCloneInvocationToProceedThreeTimes() throws Throwable {
    ...
    MethodInterceptor twoBirthdayInterceptor = new MethodInterceptor() {
      ...
      public Object invoke(MethodInvocation mi) throws Throwable {
        ...
        MethodInvocation clone1 = ((DefaultMethodInvocation) mi).invocableClone();
        MethodInvocation clone2 = ((DefaultMethodInvocation) mi).invocableClone();
        clone1.proceed();
        clone2.proceed();
        return mi.proceed();
      }
  ...
  public void testEquals() {
    ...
    assertThat(pfb.getAdvisors().length)
            .isEqualTo(pfa.getAdvisors().length);
  ...
  public void testMultiAdvice() throws Throwable {
    ...
    assertThatExceptionOfType(SpecializedUncheckedException.class)
            ...
            .isThrownBy(() -> proxied.exceptional(new SpecializedUncheckedException("foo", null)));
  ...
  public void testBeforeAdviceThrowsException() {
    ...
    // Nop2,1 didn't get invoked when the exception was thrown
    assertThat(nop1.getCount()).isEqualTo(1);
    assertThat(nop2.getCount()).isEqualTo(1);
  ...
  @SuppressWarnings("serial")
  public static class CountingMultiAdvice
          extends MethodCounter implements MethodBeforeAdvice, AfterReturningAdvice, ThrowsAdvice {
