...
import cn.taketoday.aop.proxy.AbstractAopProxyTests.IEcho;
import cn.taketoday.aop.proxy.JdkDynamicAopProxyTests.Person;
...
class ProxyFactoryBeanTests {
  ...
  public void setUp() throws Exception {
    ...
    parent.registerBeanDefinition("target2", new BeanDefinition(TestApplicationListener.class));
