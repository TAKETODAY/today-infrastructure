 ...
 * @author Chris Beams
 * @author TODAY 2021/4/11 18:38
 * @since 3.0
 */
@SuppressWarnings("serial")
public class JdkDynamicAopProxyTests extends AbstractAopProxyTests implements Serializable {
  ...
  public void testNullConfig() {
    assertThatIllegalArgumentException()
            .isThrownBy(() -> new JdkDynamicAopProxy(null));
  }
  ...
  public interface VarargTestInterface {
    ...
    @SuppressWarnings("unchecked") <V extends MyInterface> boolean doWithVarargs(V... args);
  }
