...
//	}
	...
	public <T> T[] toArray(T a[]) {
		return null; //The current operation is not supported yet
	}
	...
	/**
	 * A version of remove(Object) using the strong hint that given recent snapshot
	 * contains o at the given index.
	 */
	...
	public boolean removeAll(Collection<?> c) {
		return false;	// The current operation is not supported yet
	}
	...
	public int addAllAbsent(Collection<? extends E> c) {
		return 0; // The current operation is not supported yet
	}
