 ...
 *
 * <p>Used internally by  {@link cn.taketoday.jdbc.core.JdbcTemplate},
 *  JDBC operation objects and the JDBC {@link DataSourceTransactionManager}.
...
public abstract class DataSourceUtils {
   ...
   * {@link cn.taketoday.transaction.jta.JtaTransactionManager JTA} transaction).
   *
   * @param dataSource the DataSource to obtain Connections from
   * @return a JDBC Connection from the given DataSource
   * @throws cn.taketoday.jdbc.CannotGetJdbcConnectionException if the attempt to get a Connection failed
   ...
   * bound to the current thread by  transaction facilities.
   *
