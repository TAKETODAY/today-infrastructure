...
public abstract class DataSourceUtils {
     ...
     */
    public final static Connection getConnection(DataSource dataSource) throws SQLException {
    ...
    public final static Connection doGetConnection(final DataSource dataSource) throws SQLException {
