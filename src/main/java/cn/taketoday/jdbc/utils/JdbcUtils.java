...
import cn.taketoday.jdbc.support.DatabaseMetaDataCallback;
...
public abstract class JdbcUtils {
  ...
  /**
   * @throws PersistenceException if a database access error occurs or this method is called on a closed result set
   */
