...
public abstract class Executor implements BasicOperation {
   ...
   *
   * @param dataSource Target {@link DataSource}
   ...
   *
   * @param queryTimeout the new query timeout limit in seconds; zero means there is no
   * limit
   ...
   *
   * @param stmt Target {@link Statement}
