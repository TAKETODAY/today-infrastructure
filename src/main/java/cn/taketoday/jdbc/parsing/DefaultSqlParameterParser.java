 ...
 */
public final class DefaultSqlParameterParser extends SqlParameterParser {

  public static CharParser[] getCharParsers(Map<String, ParameterApplier> paramMap) {
  ...
  @Override
  public String parse(final String statement, final Map<String, ParameterApplier> paramMap) {
