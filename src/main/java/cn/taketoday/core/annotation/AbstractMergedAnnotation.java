...
abstract class AbstractMergedAnnotation<A extends Annotation> implements MergedAnnotation<A> {
	...
	@Override
	public cn.taketoday.core.annotation.AnnotationAttributes asAnnotationAttributes(Adapt... adaptations) {
		return asMap(mergedAnnotation -> new cn.taketoday.core.annotation.AnnotationAttributes(mergedAnnotation.getType()), adaptations);
	}
