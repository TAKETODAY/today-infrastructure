...
public interface MergedAnnotations extends Iterable<MergedAnnotation<Annotation>> {
	...
	/**
	 * Get the {@linkplain cn.taketoday.core.annotation.MergedAnnotationSelectors#nearest() nearest} matching
	 ...
	 * {@linkplain cn.taketoday.core.annotation.MergedAnnotationSelectors#nearest() nearest}
	 * @return a {@link MergedAnnotation} instance
	 * @see cn.taketoday.core.annotation.MergedAnnotationPredicates
	 * @see cn.taketoday.core.annotation.MergedAnnotationSelectors
	 */
	...
	static MergedAnnotations of(Collection<MergedAnnotation<?>> annotations) {
		return cn.taketoday.core.annotation.MergedAnnotationsCollection.of(annotations);
	}
