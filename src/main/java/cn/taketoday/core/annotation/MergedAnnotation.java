...
/**
 * A single merged annotation returned from a {@link cn.taketoday.core.annotation.MergedAnnotations}
 ...
 * @see cn.taketoday.core.annotation.MergedAnnotations
 * @see cn.taketoday.core.annotation.MergedAnnotationPredicates
 */
public interface MergedAnnotation<A extends Annotation> {
	 ...
	 * {@link cn.taketoday.core.annotation.MergedAnnotations#from(AnnotatedElement) from} an
	 ...
	 * @see cn.taketoday.core.annotation.MergedAnnotationPredicates#unique(Function)
	 * @see #getRoot()
	 * @see #getMetaSource()
	 */
