 ...
 * @author Sam Brannen
 * @since 4.0
 * @see cn.taketoday.core.annotation.AliasFor
 * @see cn.taketoday.core.annotation.AnnotationAttributes
 * @see AnnotationUtils
...
public abstract class AnnotatedElementUtils {
	...
	public static boolean isAnnotated(AnnotatedElement element, Class<? extends Annotation> annotationType) {
		...
		if (cn.taketoday.core.annotation.AnnotationFilter.PLAIN.matches(annotationType) ||
				cn.taketoday.core.annotation.AnnotationsScanner.hasPlainJavaAnnotationsOnly(element)) {
	 ...
	 * <p>{@link cn.taketoday.core.annotation.AliasFor @AliasFor} semantics are fully supported, both
	 ...
	 */
	@Nullable
	public static cn.taketoday.core.annotation.AnnotationAttributes getMergedAnnotationAttributes(
	 ...
	 */
	@Nullable
	public static cn.taketoday.core.annotation.AnnotationAttributes getMergedAnnotationAttributes(AnnotatedElement element,
	 ...
	 * of the same name from higher levels, and {@link cn.taketoday.core.annotation.AliasFor @AliasFor} semantics are
	 ...
	 * {@code annotationType}.
	 * <p>{@link cn.taketoday.core.annotation.AliasFor @AliasFor} semantics are fully supported, both within a
	 ...
	 * {@link cn.taketoday.core.annotation.AliasFor @AliasFor} semantics are fully supported, both
	 * within a single annotation and within the annotation hierarchy.
	 ...
	 */
	@Nullable
	public static cn.taketoday.core.annotation.AnnotationAttributes findMergedAnnotationAttributes(AnnotatedElement element,
	...
	@Nullable
	private static cn.taketoday.core.annotation.AnnotationAttributes getAnnotationAttributes(MergedAnnotation<?> annotation,
