...
import cn.taketoday.core.bytecode.tree.analysis.SimpleVerifier;
 ...
 *
 * <pre>
 * cn.taketoday.core.bytecode.tree.analysis.AnalyzerException: Error at instruction 71: Expected I, but found .
 *   at cn.taketoday.core.bytecode.tree.analysis.Analyzer.analyze(Analyzer.java:...)
...
public class CheckClassAdapter extends ClassVisitor {
  ...
  public ModuleVisitor visitModule(final String name, final int access, final String version) {
    ...
    CheckModuleAdapter checkModuleAdapter =
            new CheckModuleAdapter(super.visitModule(name, access, version), (access & Opcodes.ACC_OPEN) != 0);
   ...
   *         the class version.
   * @param access
   *         the method access flags to be checked.
   * @param possibleAccess
   *         the valid access flags.
   */
