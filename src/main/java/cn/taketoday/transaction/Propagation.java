...
public enum Propagation {
     ...
     * <p>
     * <b>NOTE:</b> Actual transaction suspension will not work out-of-the-box on
     ...
     * requires the {@code javax.transaction.TransactionManager} to be made
     * available it to it (which is server-specific in standard Java EE).
     */
