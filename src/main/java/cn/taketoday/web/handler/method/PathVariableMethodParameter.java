 ...
 * 2019-12-28 14:56
 */
public class PathVariableMethodParameter extends ResolvableMethodParameter {
  ...
  public Object resolveParameter(final RequestContext request) throws Throwable {
    ...
    if (pathVariables == null) {
      ...
      if (pathVariables == null) {
        throw new MissingPathVariableParameterException(getParameter());
      }
    }
    try {
      ...
      throw new ParameterConversionException(getParameter(), pathVariables[variableIndex], e);
    }
  }
