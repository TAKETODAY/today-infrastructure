 ...
 * for LocalDateTime
 *
 * @author TODAY 2021/2/23 21:15
 */
public class LocalDateTimeParameterResolver
  ...
  @Override
  protected LocalDateTime resolveInternal(String parameterValue, DateTimeFormatter formatter) {
    final TemporalAccessor temporalAccessor = formatter.parse(parameterValue);
    return DateUtils.ofDateTime(temporalAccessor);
  }
