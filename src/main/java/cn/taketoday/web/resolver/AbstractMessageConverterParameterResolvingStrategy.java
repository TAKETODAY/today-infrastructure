 ...
 */
public abstract class AbstractMessageConverterParameterResolvingStrategy implements ParameterResolvingStrategy {
  private static final Logger log = LoggerFactory.getLogger(AbstractMessageConverterParameterResolvingStrategy.class);
   ...
   */
  public AbstractMessageConverterParameterResolvingStrategy(List<HttpMessageConverter<?>> converters) {
   ...
   */
  public AbstractMessageConverterParameterResolvingStrategy(
  ...
  protected <T> Object readWithMessageConverters(
    ...
    HttpInputMessage inputMessage = createInputMessage(context);
  ...
  /**
   * Create a new {@link HttpInputMessage} from the given {@link RequestContext}.
   *
   * @param context the web request to create an input message from
   * @return the input message
   */
  protected HttpInputMessage createInputMessage(RequestContext context) {
    return context;
  }
