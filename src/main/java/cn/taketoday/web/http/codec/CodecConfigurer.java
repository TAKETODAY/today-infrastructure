...
public interface CodecConfigurer {
  ...
  interface DefaultCodecs {
     ...
     * @see cn.taketoday.web.http.codec.json.Jackson2JsonDecoder
     */
     ...
     * @see cn.taketoday.web.http.codec.json.Jackson2JsonEncoder
     */
     ...
     *
     * @param decoder the decoder instance to use
     * @see cn.taketoday.web.http.codec.json.Jackson2SmileDecoder
     */
     ...
     *
     * @param encoder the encoder instance to use
     * @see cn.taketoday.web.http.codec.json.Jackson2SmileEncoder
     */
     ...
     *
     * @param decoder the decoder instance to use
     * @see cn.taketoday.web.http.codec.protobuf.ProtobufDecoder
     * @since 4.0
     */
     ...
     *
     * @param encoder the encoder instance to use
     * @see cn.taketoday.web.http.codec.protobuf.ProtobufEncoder
     * @see cn.taketoday.web.http.codec.protobuf.ProtobufHttpMessageWriter
     * @since 4.0
     */
     ...
     *
     * @param decoder the decoder instance to use
     * @see cn.taketoday.web.http.codec.xml.Jaxb2XmlDecoder
     * @since 4.0
     */
     ...
     *
     * @param encoder the encoder instance to use
     * @see cn.taketoday.web.http.codec.xml.Jaxb2XmlEncoder
     * @since 4.0
     */
     ...
     *
     * @param decoder the decoder instance to use
     * @see cn.taketoday.web.http.codec.json.KotlinSerializationJsonDecoder
     * @since 4.0
     */
     ...
     *
     * @param encoder the encoder instance to use
     * @see cn.taketoday.web.http.codec.json.KotlinSerializationJsonEncoder
     * @since 4.0
     */
