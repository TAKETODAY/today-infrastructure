 ...
 * 2019-07-14 11:32
 */
public class TemplateReturnValueHandler extends AbstractReturnValueHandler implements RuntimeReturnValueHandler {

  private boolean allowLambdaDetect;

  public TemplateReturnValueHandler() {
    this(false, new DefaultTemplateRenderer());
  }

  public TemplateReturnValueHandler(TemplateRenderer viewResolver) {
    this(false, viewResolver);
  }

  public TemplateReturnValueHandler(boolean lambdaDetect, TemplateRenderer viewResolver) {
