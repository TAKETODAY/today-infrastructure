 ...
 * @see AfterThrowing
 */
final class AfterThrowingMethodInterceptor extends AbstractAnnotationMethodInterceptor {

  public AfterThrowingMethodInterceptor(Method method, BeanFactory beanFactory, String aspectDef) {
