 ...
 * retrieved from the enclosing {@link cn.taketoday.context.factory.BeanFactory
 ...
 * on injection points marked with {@link cn.taketoday.context.annotation.Autowired}
 * or {@link javax.inject.Inject}: In that context, it leads to the creation of a
 * lazy-resolution proxy for all affected dependencies, as an alternative to using
 * {@link cn.taketoday.context.factory.ObjectFactory} or {@link javax.inject.Provider}.
 *
 * @author Chris Beams
