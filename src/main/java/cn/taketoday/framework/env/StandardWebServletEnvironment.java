 ...
 *         2019-06-17 22:34
 */
public class StandardWebServletEnvironment extends StandardEnvironment {

    private static final Logger log = LoggerFactory.getLogger(StandardWebServletEnvironment.class);

    private final Class<?> applicationClass;

    public StandardWebServletEnvironment(Class<?> applicationClass) {
