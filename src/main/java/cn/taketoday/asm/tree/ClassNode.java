...
public class ClassNode extends ClassVisitor {
  ...
  /**
   * The class's access flags (see {@link cn.taketoday.asm.Opcodes}). This field also indicates if
   * the class is deprecated {@link Opcodes#ACC_DEPRECATED} or a record {@link Opcodes#ACC_RECORD}.
   */
  public int access;

  /** The internal name of this class (see {@link cn.taketoday.asm.Type#getInternalName}). */
  public String name;
  ...
  /**
   * The internal of name of the super class (see {@link cn.taketoday.asm.Type#getInternalName}).
