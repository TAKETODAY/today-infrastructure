...
public class ParameterNode {
  ...
  /**
   * The parameter's access flags (see {@link cn.taketoday.asm.Opcodes}). Valid values are {@code
   ...
   *         ACC_SYNTHETIC} or/and {@code ACC_MANDATED} (see {@link cn.taketoday.asm.Opcodes}).
   * @param name
   *         the parameter's name.
   */
