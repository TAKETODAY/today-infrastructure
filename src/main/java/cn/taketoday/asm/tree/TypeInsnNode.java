...
public class TypeInsnNode extends AbstractInsnNode {
   ...
   *
   * @param opcode
   *         the opcode of the type instruction to be constructed. This opcode must be NEW,
   *         ANEWARRAY, CHECKCAST or INSTANCEOF.
   * @param descriptor
   *         the operand of the instruction to be constructed. This operand is an internal
   *         name (see {@link cn.taketoday.asm.Type}).
   */
   ...
   *
   * @param opcode
   *         the new instruction opcode. This opcode must be NEW, ANEWARRAY, CHECKCAST or
   *         INSTANCEOF.
   */
