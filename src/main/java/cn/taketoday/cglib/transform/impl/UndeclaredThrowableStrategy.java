...
import cn.taketoday.cglib.transform.MethodFilter;
import cn.taketoday.cglib.transform.MethodFilterTransformer;
import cn.taketoday.cglib.transform.TransformingClassGenerator;

/**
 * A {@link GeneratorStrategy} suitable for use with
 * {@link cn.taketoday.cglib.proxy.Enhancer} which causes all undeclared
