...
public abstract class JmxUtils {
   ...
   * @see cn.taketoday.util.ObjectUtils#getIdentityHexString(Object)
   */
   ...
   * @see cn.taketoday.util.ClassUtils#getUserClass(Object)
   */
   ...
   * @return the bean class to expose
   * @see cn.taketoday.util.ClassUtils#getUserClass(Class)
   */
