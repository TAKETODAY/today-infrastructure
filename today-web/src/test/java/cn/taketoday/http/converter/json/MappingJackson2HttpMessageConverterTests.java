...
public class MappingJackson2HttpMessageConverterTests {
  ...
  public void readUntyped() throws IOException {
    ...
    assertThat((Double) result.get("fraction")).isCloseTo(42D, Assertions.within(0D));
  ...
  public void readNonUnicode() throws Exception {
    ...
    assertThat(result).containsExactly(Assertions.entry("føø", "bår"));
  }
  ...
  public void readAscii() throws Exception {
    ...
    assertThat(result).containsExactly(Assertions.entry("foo", "bar"));
  }
