...
class RequestParamMapMethodArgumentResolverTests {
  ...
  public void supportsParameter() {
    ResolvableMethodParameter param = this.testMethod.annot(requestParam().noName()).arg(Map.class, String.class, String.class);
  ...
  public void resolveMapOfMultipartFile() throws Throwable {
    ...
    ResolvableMethodParameter param = this.testMethod.annot(requestParam().noName()).arg(Map.class, String.class, MultipartFile.class);
    Object result = resolver.resolveArgument(webRequest, param);
  ...
  public void resolveMapOfPart() throws Throwable {
    ...
    ResolvableMethodParameter param = this.testMethod.annot(requestParam().noName()).arg(Map.class, String.class, Part.class);
    Object result = resolver.resolveArgument(webRequest, param);
