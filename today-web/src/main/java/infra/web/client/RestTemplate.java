 ...
 * {@link infra.web.client.reactive.WebClient}.
 *
...
public class RestTemplate extends InterceptingHttpAccessor implements RestOperations {
   ...
   * @see infra.http.client.JdkClientHttpRequestFactory
   ...
   * @see infra.web.util.DefaultUriTemplateHandler
   */
   ...
   */
  private static final class HeadersExtractor implements ResponseExtractor<HttpHeaders> {
