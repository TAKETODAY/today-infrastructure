...
public class WebContentInterceptor extends WebContentGenerator implements HandlerInterceptor {
  ...
  /**
   * Map specific URL paths to a specific {@link infra.http.CacheControl}.
   * <p>Overrides the default cache seconds setting of this interceptor.
   * Can specify a empty {@link infra.http.CacheControl} instance
  ...
  /**
   * Find a {@link infra.http.CacheControl} instance for the
