...
public class ParameterParser {
   ...
   * @return the token
   */
  private @Nullable String getToken(final boolean quoted) {
   ...
   * @return a map of name/value pairs
   */
  public Map<String, String> parse(final char @Nullable [] charArray, final int offset, final int length, final char separator) {
    if (charArray == null) {
      return new HashMap<>();
    }
   ...
   * @return a map of name/value pairs
   */
  public Map<String, String> parse(final @Nullable String str, final char separator) {
    if (str == null) {
      return new HashMap<>();
    }
   ...
   * @return a map of name/value pairs
   */
  public Map<String, String> parse(final @Nullable String str, final char @Nullable [] separators) {
