...
final class MultipartInput {
  ...
  public static class Builder extends AbstractStreamBuilder<MultipartInput, Builder> {
     ...
     * Boundary.
     */
    private byte @Nullable [] boundary;

    /**
     * Progress notifier.
     */
    private @Nullable ProgressNotifier progressNotifier;
     ...
     */
    public Builder boundary(final byte @Nullable [] boundary) {
     ...
     * @return This builder.
     */
    public Builder maxPartHeaderSize(final int partHeaderSizeMax) {
     ...
     * @return {@code this} instance.
     */
    public Builder progressNotifier(final @Nullable ProgressNotifier progressNotifier) {
   ...
   */
  private final @Nullable ProgressNotifier notifier;
  ...
  public String readHeaders() throws FileUploadSizeException, MalformedStreamException {
    ...
    return baos.toString(Objects.requireNonNullElse(headerCharset, Charset.defaultCharset()));
  }
