 ...
 *
 * <p>After retrieving an instance of this class from a {@link DiskFileItemFactory} instance
 ...
 * {@link FileCleaningTracker}, which you can set on the {@link DiskFileItemFactory}. However, if you do use such a tracker, then you must
 ...
 * {@link FileCleaningTracker} when there are files to be tracked. It might make sense to terminate that thread, for example, if your web
...
public final class DiskFileItem implements FileItem<DiskFileItem> {
   ...
   */
  public static @Nullable String checkFileName(final @Nullable String fileName) {
    if (fileName != null) {
   ...
   */
  private HttpHeaders fileItemHeaders;
  ...
  private DiskFileItem(final Builder builder) {
    ...
    this.fileItemHeaders = builder.getItemHeaders();
   ...
   */
  @Override
  public byte @Nullable [] getContentAsByteArray() throws IOException {
    if (dos != null) {
  ...
  /**
   * Gets the contents of the file as a String, using the default character encoding. This method uses {@link #getContentAsByteArray()} to retrieve the contents of the file.
   *
