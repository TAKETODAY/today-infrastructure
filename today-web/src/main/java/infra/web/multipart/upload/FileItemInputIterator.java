...
/**
 * An iterator, as returned by {@link FileUpload#getItemIterator(infra.web.RequestContext)}.
 *
...
public interface FileItemInputIterator {
   ...
   * this value. By default, this value will be copied from the {@link FileUpload#getMaxFileSize() FileUploadBase} object, however, the user may
