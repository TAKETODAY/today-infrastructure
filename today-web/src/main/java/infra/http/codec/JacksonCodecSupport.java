...
public abstract class JacksonCodecSupport<T extends ObjectMapper> {
   ...
   * {@link infra.http.codec.HttpMessageReader#read(ResolvableType, ResolvableType, ServerHttpRequest, ServerHttpResponse, Map)}
  ...
  protected JacksonCodecSupport(MapperBuilder<T, ?> builder, MimeType... mimeTypes) {
    Assert.notNull(builder, "MapperBuilder is required");
