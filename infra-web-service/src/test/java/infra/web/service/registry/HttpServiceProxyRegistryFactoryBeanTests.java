...
import infra.web.service.support.RestClientHttpServiceGroupConfigurer;
import infra.web.testfixture.http.MockClientHttpRequest;
import infra.web.testfixture.http.MockClientHttpResponse;

import static infra.web.service.registry.HttpServiceGroup.ClientType.REST_CLIENT;
...
public class HttpServiceProxyRegistryFactoryBeanTests {
  ...
  void initializeClientBuilder() throws Exception {
    ...
    RestClient.Builder clientBuilder = RestClient.builder().baseURI("/").requestFactory(requestFactory);
