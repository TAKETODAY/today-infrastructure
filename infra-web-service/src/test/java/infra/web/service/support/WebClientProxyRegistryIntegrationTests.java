...
import infra.web.service.registry.AbstractHttpServiceRegistrar;
import infra.web.service.registry.HttpServiceGroup.ClientType;
import infra.web.service.registry.HttpServiceProxyRegistry;
import infra.web.service.registry.ImportHttpServices;
import infra.web.service.registry.echo.EchoA;
import infra.web.service.registry.echo.EchoB;
import infra.web.service.registry.greeting.GreetingA;
import infra.web.service.registry.greeting.GreetingB;
 ...
 * {@link infra.web.reactive.client.WebClient}.
 *
  ...
  private static class BaseEchoConfig {
    ...
    public WebClientHttpServiceGroupConfigurer groupConfigurer() {
      return groups -> groups.filterByName("echo", "greeting")
              .forEachClient((group, builder) -> builder.baseURI("http://localhost:9090"));
    }
  }
