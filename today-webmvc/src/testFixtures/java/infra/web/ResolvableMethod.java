...
import infra.bytecode.core.DefaultNamingPolicy;
 ...
 *
 * <pre>
 * import static infra.web.method.ResolvableMethod.on;
 * import static infra.web.method.MvcAnnotationPredicates.requestMapping;
 *
 * // Return type
 ...
 *
 * <pre>
 * import static infra.web.method.MvcAnnotationPredicates.requestParam;
 *
...
public class ResolvableMethod {
  ...
  private static class MethodInvocationInterceptor
          implements infra.bytecode.proxy.MethodInterceptor, MethodInterceptor {
