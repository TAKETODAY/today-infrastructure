...
public class UrlBasedViewResolverRegistration {
   ...
   *
   * @see infra.web.view.UrlBasedViewResolver#setSuffix
   */
   ...
   *
   * @see infra.web.view.UrlBasedViewResolver#setViewClass
   */
   ...
   *
   * @see infra.web.view.UrlBasedViewResolver#setViewNames
   */
   ...
   *
   * @see infra.web.view.UrlBasedViewResolver#setAttributesMap
   */
   ...
   * Default is 1024.
   *
   * @see infra.web.view.UrlBasedViewResolver#setCache(boolean)
   */
