...
public abstract class AbstractMarshallerTests<M extends Marshaller> {
  ...
  public void marshalDOMResult() throws Exception {
    ...
    Assertions.assertThat(XmlContent.of(result)).isSimilarToIgnoringWhitespace(expected);
  }
  ...
  public void marshalStreamResultWriter() throws Exception {
    ...
    Assertions.assertThat(XmlContent.of(writer)).isSimilarToIgnoringWhitespace(EXPECTED_STRING);
  }
  ...
  public void marshalStreamResultOutputStream() throws Exception {
    ...
    marshaller.marshal(flights, result);
    Assertions.assertThat(XmlContent.of(new String(os.toByteArray(), "UTF-8"))).isSimilarToIgnoringWhitespace(EXPECTED_STRING);
  }
  ...
  public void marshalStaxResultStreamWriter() throws Exception {
    ...
    marshaller.marshal(flights, result);
    Assertions.assertThat(XmlContent.from(writer)).isSimilarToIgnoringWhitespace(EXPECTED_STRING);
  }
