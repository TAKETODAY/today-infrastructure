...
class SourceFileTests {
  ...
  void forClassWithClassUsesClass() {
    ...
    assertThat(sourceFile.getPath()).isEqualTo("infra/core/test/tools/SourceFileTests.java");
    assertThat(sourceFile.getClassName()).isEqualTo("infra.core.test.tools.SourceFileTests");
  }
  ...
  void getClassNameFromAnnotatedRecord() {
    SourceFile sourceFile = SourceFile.of("""
            	...
            	public record RecordProperties(
            			@infra.lang.NonNull("test") String property1,
            			@infra.lang.NonNull("test") String property2) {
            	}
            """);
