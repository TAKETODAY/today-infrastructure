...
enum InstrumentedMethod {
  ...
  CLASS_GETDECLAREDCONSTRUCTOR(Class.class, "getDeclaredConstructor", HintType.REFLECTION, invocation -> {
    ...
    return reflection()
            .onType(thisType)
            .withMemberCategory(MemberCategory.INTROSPECT_DECLARED_CONSTRUCTORS)
  ...
  CLASS_GETDECLAREDMETHODS(Class.class, "getDeclaredMethods", HintType.REFLECTION, invocation -> {
    Class<?> thisClass = invocation.getInstance();
    return reflection()
            .onType(TypeReference.of(thisClass))
            .withAnyMemberCategory(MemberCategory.INTROSPECT_DECLARED_METHODS, MemberCategory.INVOKE_DECLARED_METHODS);
  }),
  ...
  CLASS_GETMETHOD(Class.class, "getMethod", HintType.REFLECTION, invocation -> {
    ...
    return reflection()
            .onType(thisType)
            .withAnyMemberCategory(MemberCategory.INTROSPECT_PUBLIC_METHODS, MemberCategory.INVOKE_PUBLIC_METHODS)
