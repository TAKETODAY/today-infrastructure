...
public final class TestCompiler {
  ...
  private DynamicClassLoader compile() {
    ...
    if (!this.sourceFiles.isEmpty()) {
      ...
      JavaCompiler.CompilationTask task = this.compiler.getTask(null, fileManager, problems,
  ...
  static class Problems implements DiagnosticListener<JavaFileObject> {
    ...
    private String toMessage(Diagnostic<? extends @Nullable JavaFileObject> diagnostic) {
