...
import infra.beans.testfixture.beans.factory.aot.CustomBean;
import infra.beans.testfixture.beans.factory.aot.CustomPropertyValue;
import infra.beans.testfixture.beans.factory.aot.InnerBeanConfiguration;
import infra.beans.testfixture.beans.factory.aot.MockBeanRegistrationsCode;
import infra.beans.testfixture.beans.factory.aot.SimpleBean;
import infra.beans.testfixture.beans.factory.aot.SimpleBeanConfiguration;
...
class BeanDefinitionMethodGeneratorTests {
  ...
  void generateBeanDefinitionMethodUSeBeanClassNameIfNotReachable() {
    ...
    compile(method, (actual, compiled) -> {
      SourceFile sourceFile = compiled.getSourceFile(".*BeanDefinitions");
      assertThat(sourceFile).contains("Get the bean definition for 'testBean'");
      assertThat(sourceFile).contains("new RootBeanDefinition(\"infra.beans.factory.aot.PackagePrivateTestBean\"");
