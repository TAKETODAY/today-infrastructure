...
import infra.beans.factory.config.MethodInvokingBean;
...
class MethodInvokingFactoryBeanTests {
  ...
  public void testGetObject() throws Exception {
    ...
    TestClass1._staticField1 = 0;
    mcfb = new MethodInvokingFactoryBean();
    mcfb.setStaticMethod("infra.beans.factory.support.MethodInvokingFactoryBeanTests$TestClass1.staticMethod1");
    mcfb.setSingleton(false);
    mcfb.afterPropertiesSet();
    i = (Integer) mcfb.getObject();
    assertThat(i.intValue()).isEqualTo(1);
