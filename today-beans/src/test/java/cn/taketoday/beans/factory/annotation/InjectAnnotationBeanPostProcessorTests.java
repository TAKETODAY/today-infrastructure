...
/**
 * Unit tests for {@link cn.taketoday.beans.factory.support.StandardDependenciesBeanPostProcessor}
...
public class InjectAnnotationBeanPostProcessorTests {
  ...
  /**
   * Verifies that a dependency on a {@link cn.taketoday.beans.factory.FactoryBean}
   * can be autowired via {@link cn.taketoday.beans.factory.annotation.Autowired @Inject},
  ...
  /**
   * Bean with a dependency on a {@link cn.taketoday.beans.factory.FactoryBean}.
   */
