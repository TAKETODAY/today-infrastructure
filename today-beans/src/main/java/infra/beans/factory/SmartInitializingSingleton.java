 ...
 *
 * <p>This callback variant is somewhat similar to {@link infra.context.event.ContextStartedEvent}
 * but doesn't require an implementation of {@link infra.context.ApplicationListener},
 ...
 * not just in an {@link infra.context.ApplicationContext} environment.
 *
 * <p><b>NOTE:</b> If you intend to start/manage asynchronous tasks, preferably
 * implement {@link infra.context.Lifecycle} instead which offers
