...
public interface ConfigurableBeanFactory extends HierarchicalBeanFactory, SingletonBeanRegistry, AutowireCapableBeanFactory {
   ...
   * {@link Ordered} interface will be ignored. Note that
  ...
  /**
   * Set the {@link Executor} (possibly a {@link TaskExecutor})
  ...
  /**
   * Return the {@link Executor} (possibly a {@link TaskExecutor})
