...
`cn.taketoday.web.servlet.i18n` package and are configured in your application
...
----
<bean id="localeResolver" class="cn.taketoday.web.servlet.i18n.CookieLocaleResolver">
...
<bean id="localeChangeInterceptor"
    class="cn.taketoday.web.servlet.i18n.LocaleChangeInterceptor">
  <property name="paramName" value="siteLanguage"/>
</bean>

<bean id="localeResolver"
    class="cn.taketoday.web.servlet.i18n.CookieLocaleResolver"/>

<bean id="urlMapping"
    class="cn.taketoday.web.servlet.handler.SimpleUrlHandlerMapping">
