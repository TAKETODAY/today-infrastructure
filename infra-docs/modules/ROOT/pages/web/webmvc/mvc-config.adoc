...
and the MVC namespace. If you want to learn more, see xref:web/webmvc/mvc-core/special-bean-types.adoc[Special Bean Types]
and xref:web/webmvc/mvc-core/config.adoc[Web MVC Config].
