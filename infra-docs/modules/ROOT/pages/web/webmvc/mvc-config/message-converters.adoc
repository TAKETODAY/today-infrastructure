...
{today-framework-api}/web/servlet/config/annotation/WebMvcConfigurer.html#configureMessageConverters-java.util.List-[`configureMessageConverters()`].
You can also customize the list of configured message converters at the end by overriding
{today-framework-api}/web/servlet/config/annotation/WebMvcConfigurer.html#extendMessageConverters-java.util.List-[`extendMessageConverters()`].
...
Boot application, prefer to use the {today-framework-reference}/web.html#web.servlet.spring-mvc.message-converters[HttpMessageConverters]
