...
`<@infra.bind>` requires a 'path' argument, which consists of the name of your command
...
An alternative form of the macro called `<@infra.bindEscaped>` takes a second argument
