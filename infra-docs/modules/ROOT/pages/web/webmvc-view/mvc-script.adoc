...
* `Map model`: 视图模型
* `RenderingContext renderingContext`: {today-framework-api}/web/view/script/RenderingContext.html[`RenderingContext`]，提供对应用程序上下文、区域设置、模板加载器和 URL（自 5.0 起）的访问
...
{today-framework-code}/infra-web/src/test/java/infra/web/view/script[Java] 和
{today-framework-code}/infra-web/src/test/resources/infra/web/view/script[资源]，
了解更多配置示例。
