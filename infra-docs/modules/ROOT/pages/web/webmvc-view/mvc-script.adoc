...
{today-framework-code}/infra-web/src/test/java/infra/web/mockApi/view/script[Java], and
{today-framework-code}/infra-web/src/test/resources/infra/web/mockApi/view/script[resources],
