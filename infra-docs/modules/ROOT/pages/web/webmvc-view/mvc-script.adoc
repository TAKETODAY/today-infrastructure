...
{today-framework-code}/today-web/src/test/java/cn/taketoday/web/servlet/view/script[Java], and
{today-framework-code}/today-web/src/test/resources/cn/taketoday/web/servlet/view/script[resources],
