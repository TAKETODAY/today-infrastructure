...
`infra.test.context.cache` logging category to `DEBUG`.
...
`@DirtiesContext` in xref:testing/annotations/integration-infra/annotation-dirtiescontext.adoc[Infra Testing Annotations]
...
execution of a test method according to xref:testing/annotations/integration-infra/annotation-dirtiescontext.adoc[`@DirtiesContext`]
