...
type but also Spring's `cn.taketoday.util.concurrent.ListenableFuture` or, as of
...
However, you can manually set up Spring's `AsyncExecutionInterceptor` with Infra AOP,
