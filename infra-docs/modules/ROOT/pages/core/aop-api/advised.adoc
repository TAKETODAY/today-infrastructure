...
`cn.taketoday.aop.framework.Advised` interface. Any AOP proxy can be cast to this
...
interceptor or other advice type, Infra wrapped this in an advisor with a
