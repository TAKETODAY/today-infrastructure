...
This section describes some semantics of transaction propagation in Infra. Note
that this section is not a proper introduction to transaction propagation. Rather, it
details some of the semantics regarding transaction propagation in Infra.

In Infra-managed transactions, be aware of the difference between physical and
