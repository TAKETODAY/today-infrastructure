...
Infra distribution. This file contains the XML Schema for Infra transaction
...
elements from the `aop` namespace (since the declarative transaction support in Infra is
