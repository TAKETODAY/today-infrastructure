...
class SqlLobValueTests {
  ...
  void test5() throws Exception {
    ...
    lob.setTypeValue(preparedStatement, 1, Types.CLOB, "test");
    verify(creator).setClobAsAsciiStream(ArgumentMatchers.eq(preparedStatement), ArgumentMatchers.eq(1), inputStreamCaptor.capture(), ArgumentMatchers.eq(3));
  ...
  void test6() throws SQLException {
    ...
    lob.setTypeValue(preparedStatement, 1, Types.CLOB, "test");
    verify(creator).setClobAsCharacterStream(ArgumentMatchers.eq(preparedStatement), ArgumentMatchers.eq(1), ArgumentMatchers.eq(reader), ArgumentMatchers.eq(3));
  }
