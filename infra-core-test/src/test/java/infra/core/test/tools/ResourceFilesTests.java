...
class ResourceFilesTests {
  ...
  void ofCreatesResourceFiles() {
    ...
    Assertions.assertThat(resourceFiles).containsExactly(RESOURCE_FILE_1, RESOURCE_FILE_2);
  }
  ...
  void andAddsResourceFiles() {
    ...
    Assertions.assertThat(resourceFiles).containsExactly(RESOURCE_FILE_1);
    Assertions.assertThat(added).containsExactly(RESOURCE_FILE_1, RESOURCE_FILE_2);
  }
  ...
  void streamStreamsResourceFiles() {
    ResourceFiles resourceFiles = ResourceFiles.of(RESOURCE_FILE_1, RESOURCE_FILE_2);
    Assertions.assertThat(resourceFiles.stream()).containsExactly(RESOURCE_FILE_1,
            RESOURCE_FILE_2);
  }
