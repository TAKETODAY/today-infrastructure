...
public enum TestImage {
  ...
  private final @Nullable Class<?> containerClass;

  private final @Nullable Consumer<?> containerSetup;

  TestImage(String name) {
    this(name, null);
  }

  TestImage(String name, @Nullable String tag) {
    this(name, tag, null, null);
  }

  TestImage(String name, @Nullable String tag, @Nullable Supplier<Class<?>> containerClass) {
    this(name, tag, containerClass, null);
  }

  TestImage(String name, @Nullable String tag, @Nullable Consumer<?> containerSetup) {
    this(name, tag, null, containerSetup);
  }

  TestImage(String name, @Nullable String tag, @Nullable Supplier<Class<?>> containerClass, @Nullable Consumer<?> containerSetup) {
    this.name = name;
    this.tag = tag;
  ...
  static @Nullable Class<?> getIfPossible(@Nullable Supplier<Class<?>> supplier) {
    try {
