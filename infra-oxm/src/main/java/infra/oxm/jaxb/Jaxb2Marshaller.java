...
import infra.oxm.GenericUnmarshaller;
...
import infra.oxm.ValidationFailureException;
import infra.oxm.XmlMappingException;
import infra.oxm.mime.MimeContainer;
import infra.oxm.mime.MimeMarshaller;
import infra.oxm.mime.MimeUnmarshaller;
import infra.oxm.support.SaxResourceUtils;
...
public class Jaxb2Marshaller implements MimeMarshaller, MimeUnmarshaller,
   ...
   * {@link infra.web.view.xml.MarshallingView MarshallingView},
   ...
   * from the {@code infra.oxm} hierarchy.
   *
