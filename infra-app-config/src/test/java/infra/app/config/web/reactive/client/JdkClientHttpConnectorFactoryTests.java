...
/**
 * Tests for {@link infra.app.config.web.reactive.client.JdkClientHttpConnectorFactory}.
 *
 * @author Phillip Webb
 */
class JdkClientHttpConnectorFactoryTests extends AbstractClientHttpConnectorFactoryTests {
  ...
  protected ClientHttpConnectorFactory<?> getFactory() {
    return new infra.app.config.web.reactive.client.JdkClientHttpConnectorFactory();
  }
