...
/**
 * Tests for {@link infra.app.config.web.reactive.client.HttpComponentsClientHttpConnectorFactory}.
 *
 * @author Phillip Webb
 */
class HttpComponentsClientHttpConnectorFactoryTests extends AbstractClientHttpConnectorFactoryTests {
  ...
  protected ClientHttpConnectorFactory<?> getFactory() {
    return new infra.app.config.web.reactive.client.HttpComponentsClientHttpConnectorFactory();
  }
