...
class ImportAutoConfigurationImportSelectorTests {
  ...
  @Test
  @WithResource(name = "META-INF/config/infra.app.config.ImportAutoConfigurationImportSelectorTests$FromImportsFile.imports",
          content = """
                  infra.app.config.ImportAutoConfigurationImportSelectorTests$ImportedAutoConfiguration
  ...
  @Test
  @WithResource(
          name = "META-INF/config/infra.app.config.ImportAutoConfigurationImportSelectorTests$FromImportsFile.imports",
          content = """
                  optional:infra.app.config.ImportAutoConfigurationImportSelectorTests$ImportedAutoConfiguration
                  optional:infra.app.config.missing.MissingAutoConfiguration
                  infra.app.config.ImportAutoConfigurationImportSelectorTests$AnotherImportedAutoConfiguration
                  """)
