...
/**
 * Tests for {@link infra.app.config.ssl.SslAutoConfiguration}.
 *
...
class SslAutoConfigurationTests {
  ...
  private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
          .withConfiguration(AutoConfigurations.of(infra.app.config.ssl.SslAutoConfiguration.class));
  ...
  void sslBundlesCreatedWithCertificates() {
    ...
    propertyValues.add(
            "ssl.bundle.pem.first.keystore.certificate=classpath:infra/app/config/ssl/rsa-cert.pem");
    propertyValues.add(
            "ssl.bundle.pem.first.keystore.private-key=classpath:infra/app/config/ssl/rsa-key.pem");
    ...
    propertyValues.add(
            "ssl.bundle.pem.first.truststore.certificate=classpath:infra/app/config/ssl/rsa-cert.pem");
    propertyValues.add(
            "ssl.bundle.pem.first.truststore.private-key=classpath:infra/app/config/ssl/rsa-key.pem");
    propertyValues.add("ssl.bundle.pem.second.key.alias=alias2");
    propertyValues.add("ssl.bundle.pem.second.key.password=secret2");
    propertyValues.add(
            "ssl.bundle.pem.second.keystore.certificate=classpath:infra/app/config/ssl/ed25519-cert.pem");
    propertyValues.add(
            "ssl.bundle.pem.second.keystore.private-key=classpath:infra/app/config/ssl/ed25519-key.pem");
    propertyValues.add("ssl.bundle.pem.second.keystore.type=PKCS12");
    propertyValues.add(
            "ssl.bundle.pem.second.truststore.certificate=classpath:infra/app/config/ssl/ed25519-cert.pem");
    propertyValues.add(
            "ssl.bundle.pem.second.truststore.private-key=classpath:infra/app/config/ssl/ed25519-key.pem");
  ...
  void sslBundlesCreatedWithCustomSslBundle() {
    ...
    propertyValues.add("custom.ssl.keystore.certificate=classpath:infra/app/config/ssl/rsa-cert.pem");
    propertyValues.add("custom.ssl.keystore.keystore.private-key=classpath:infra/app/config/ssl/rsa-key.pem");
    propertyValues.add("custom.ssl.truststore.certificate=classpath:infra/app/config/ssl/rsa-cert.pem");
  ...
  static class CustomSslProperties extends infra.app.config.ssl.PemSslBundleProperties {
  ...
  static class CustomSslBundlesRegistrar implements SslBundleRegistrar {
    ...
    public void registerBundles(SslBundleRegistry registry) {
      registry.registerBundle("custom", infra.app.config.ssl.PropertiesSslBundle.get(this.properties));
    }
