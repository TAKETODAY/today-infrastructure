...
class JmxAutoConfigurationTests {
  ...
  private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
          .withConfiguration(AutoConfigurations.of(infra.app.config.jmx.JmxAutoConfiguration.class));
  ...
  void testBasicParentContext() {
    ...
    parent.register(infra.app.config.jmx.JmxAutoConfiguration.class);
    parent.refresh();
  ...
  void testParentContext() {
    AnnotationConfigApplicationContext parent = new AnnotationConfigApplicationContext();
    parent.register(infra.app.config.jmx.JmxAutoConfiguration.class, TestConfiguration.class);
    parent.refresh();
