...
class BodyInsertersTests {
  ...
  void ofString() {
    String body = "foo";
    BodyInserter<String, ReactiveHttpOutputMessage> inserter = infra.web.reactive.BodyInserters.fromValue(body);
  ...
  void ofObject() {
    ...
    BodyInserter<User, ReactiveHttpOutputMessage> inserter = infra.web.reactive.BodyInserters.fromValue(body);
    MockServerHttpResponse response = new MockServerHttpResponse();
    Mono<Void> result = inserter.insert(response, this.context);
    StepVerifier.create(result).expectComplete().verify();
  ...
  void ofProducerWithMono() {
    ...
    BodyInserter<?, ReactiveHttpOutputMessage> inserter = infra.web.reactive.BodyInserters.fromProducer(body, User.class);
  ...
  void ofProducerWithFlux() {
    ...
    BodyInserter<?, ReactiveHttpOutputMessage> inserter = infra.web.reactive.BodyInserters.fromProducer(body, String.class);
  ...
  void ofPublisher() {
    Flux<String> body = Flux.just("foo");
    BodyInserter<Flux<String>, ReactiveHttpOutputMessage> inserter = infra.web.reactive.BodyInserters.fromPublisher(body, String.class);
  ...
  void ofResource() throws IOException {
    ...
    MockServerHttpResponse response = new MockServerHttpResponse();
    Mono<Void> result = infra.web.reactive.BodyInserters.fromResource(resource).insert(response, this.context);
    StepVerifier.create(result).expectComplete().verify();
  ...
  public void ofResourceWithExplicitMediaType() throws IOException {
    ...
    Mono<Void> result = infra.web.reactive.BodyInserters.fromResource(resource).insert(request, this.context);
    StepVerifier.create(result).expectComplete().verify();
  ...
  void ofResourceRange() throws IOException {
    ...
    BodyInserter<Resource, ReactiveHttpOutputMessage> inserter = infra.web.reactive.BodyInserters.fromResource(body);
  ...
  void ofServerSentEventFlux() {
    ...
    BodyInserter<Flux<ServerSentEvent<String>>, ServerHttpResponse> inserter =
            infra.web.reactive.BodyInserters.fromServerSentEvents(body);
  ...
  void fromFormDataMap() {
    ...
    BodyInserter<MultiValueMap<String, String>, ClientHttpRequest>
            inserter = infra.web.reactive.BodyInserters.fromFormData(body);
  ...
  void fromFormDataWith() {
    BodyInserter<MultiValueMap<String, String>, ClientHttpRequest>
            inserter = infra.web.reactive.BodyInserters.fromFormData("name 1", "value 1")
  ...
  void fromMultipartData() {
    ...
    infra.web.reactive.BodyInserters.FormInserter<Object> inserter =
            infra.web.reactive.BodyInserters.fromMultipartData("name 1", "value 1")
  ...
  public void fromMultipartDataWithMultipleValues() {
    ...
    infra.web.reactive.BodyInserters.FormInserter<Object> inserter = infra.web.reactive.BodyInserters.fromMultipartData(map);
  ...
  void ofDataBuffers() {
    ...
    BodyInserter<Flux<DataBuffer>, ReactiveHttpOutputMessage> inserter = infra.web.reactive.BodyInserters.fromDataBuffers(body);
