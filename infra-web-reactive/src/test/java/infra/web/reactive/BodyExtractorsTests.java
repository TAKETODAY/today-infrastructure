...
class BodyExtractorsTests {
  ...
  @Test
  void toMono() {
    BodyExtractor<Mono<String>, ReactiveHttpInputMessage> extractor = infra.web.reactive.BodyExtractors.toMono(String.class);
  ...
  void toMonoParameterizedTypeReference() {
    BodyExtractor<Mono<Map<String, String>>, ReactiveHttpInputMessage> extractor =
            infra.web.reactive.BodyExtractors.toMono(new ParameterizedTypeReference<>() { });
  ...
  void toMonoWithHints() {
    BodyExtractor<Mono<User>, ReactiveHttpInputMessage> extractor = infra.web.reactive.BodyExtractors.toMono(User.class);
  ...
  void toMonoVoidAsClientShouldConsumeAndCancel() {
    ...
    BodyExtractor<Mono<Void>, ReactiveHttpInputMessage> extractor = infra.web.reactive.BodyExtractors.toMono(Void.class);
  ...
  @Test
  void toFlux() {
    BodyExtractor<Flux<String>, ReactiveHttpInputMessage> extractor = infra.web.reactive.BodyExtractors.toFlux(String.class);
  ...
  void toFluxWithHints() {
    BodyExtractor<Flux<User>, ReactiveHttpInputMessage> extractor = infra.web.reactive.BodyExtractors.toFlux(User.class);
    this.hints.put(JSON_VIEW_HINT, SafeToDeserialize.class);
  ...
  void toFormData() {
    ...
    Mono<MultiValueMap<String, String>> result = infra.web.reactive.BodyExtractors.toFormData().extract(request, this.context);
  ...
  @Test
  void toParts() {
    BodyExtractor<Flux<Part>, ServerHttpRequest> extractor = infra.web.reactive.BodyExtractors.toParts();
  ...
  @Test
  void toDataBuffers() {
    BodyExtractor<Flux<DataBuffer>, ReactiveHttpInputMessage> extractor = infra.web.reactive.BodyExtractors.toDataBuffers();
