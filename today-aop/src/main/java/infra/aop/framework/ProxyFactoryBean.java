...
import infra.aop.framework.adapter.UnknownAdviceTypeException;
 ...
 * AOP proxy based on beans in {@link BeanFactory}.
 *
 * <p>{@link org.aopalliance.intercept.MethodInterceptor MethodInterceptors} and
 * {@link infra.aop.Advisor Advisors} are identified by a list of bean
 ...
 * {@link infra.aop.TargetSource}; however, it is normally preferable
...
public class ProxyFactoryBean extends ProxyCreatorSupport
   ...
   * @see #setTargetSource(infra.aop.TargetSource)
   */
