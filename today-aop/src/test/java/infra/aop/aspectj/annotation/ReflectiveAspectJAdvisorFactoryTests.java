...
class ReflectiveAspectJAdvisorFactoryTests {
  ...
  @Aspect("pertypewithin(infra.beans.testfixture.beans.IOther+)")
  ...
  static class NamedPointcutAspectWithFQN {
    ...
    @Around("infra.aop.aspectj.annotation.ReflectiveAspectJAdvisorFactoryTests.CommonPointcuts.getAge()")
  ...
  static class NamedPointcutAspectFromLibrary {
    ...
    @Around("infra.aop.aspectj.annotation.ReflectiveAspectJAdvisorFactoryTests.Library.propertyAccess()")
    int changeReturnType(ProceedingJoinPoint pjp) {
      return -1;
    }

    @Around(value = "infra.aop.aspectj.annotation.ReflectiveAspectJAdvisorFactoryTests.Library.integerArgOperation(x)",
            argNames = "pjp,x")
  ...
  static class NamedPointcutAspectFromLibraryWithBinding {
    ...
    @Around(value = "infra.aop.aspectj.annotation.ReflectiveAspectJAdvisorFactoryTests.Library.integerArgOperation(x)", argNames = "pjp,x")
    void doubleArg(ProceedingJoinPoint pjp, int x) throws Throwable {
      pjp.proceed(new Object[] { x * 2 });
    }
  }
...
class MakeITestBeanModifiable extends AbstractMakeModifiable {
  ...
  @DeclareParents(value = "infra.beans.testfixture.beans.ITestBean+",
...
class MakeAnnotatedTypeModifiable extends AbstractMakeModifiable {
  ...
  @DeclareParents(value = "(@infra.aop.aspectj.annotation.Measured *)",
...
class MakeLockable {
  ...
  @DeclareParents(value = "infra..*", defaultImpl = DefaultLockable.class)
  static Lockable mixin;
