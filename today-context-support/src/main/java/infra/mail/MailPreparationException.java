...
public class MailPreparationException extends MailException {
   ...
   */
  public MailPreparationException(@Nullable String msg, @Nullable Throwable cause) {
    super(msg, cause);
  }

  public MailPreparationException(@Nullable Throwable cause) {
    this("Could not prepare mail", cause);
  }
