...
/**
 * Tests for {@link infra.app.config.ssl.BundleContentProperty}.
 *
...
class BundleContentPropertyTests {
  ...
  void isPemContentWhenValueIsPemTextReturnsTrue() {
    infra.app.config.ssl.BundleContentProperty property = new infra.app.config.ssl.BundleContentProperty("name", PEM_TEXT);
    assertThat(property.isPemContent()).isTrue();
  }

  @Test
  void isPemContentWhenValueIsNotPemTextReturnsFalse() {
    infra.app.config.ssl.BundleContentProperty property = new infra.app.config.ssl.BundleContentProperty("name", "file.pem");
  ...
  void hasValueWhenHasNullValueReturnsFalse() {
    infra.app.config.ssl.BundleContentProperty property = new infra.app.config.ssl.BundleContentProperty("name", null);
    assertThat(property.hasValue()).isFalse();
  }

  @Test
  void hasValueWhenHasEmptyValueReturnsFalse() {
    infra.app.config.ssl.BundleContentProperty property = new infra.app.config.ssl.BundleContentProperty("name", "");
    assertThat(property.hasValue()).isFalse();
  }
  ...
  void toWatchPathWhenPathReturnsPath() throws URISyntaxException {
    ...
    infra.app.config.ssl.BundleContentProperty property = new infra.app.config.ssl.BundleContentProperty("name", file.toString());
  ...
  void shouldThrowBundleContentNotWatchableExceptionIfContentIsNotWatchable() {
    infra.app.config.ssl.BundleContentProperty property = new infra.app.config.ssl.BundleContentProperty("name", "https://example.com/");
    assertThatExceptionOfType(infra.app.config.ssl.BundleContentNotWatchableException.class)
